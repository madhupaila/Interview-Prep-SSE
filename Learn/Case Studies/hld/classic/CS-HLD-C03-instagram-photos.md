# Design Instagram / Photo Sharing — Case Study

**Case Study ID:** CS-HLD-C03
**Track:** Classic HLD
**Companies:** Meta, Snap
**Difficulty:** Medium
**Related question:** [Q03-instagram-photos.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q03-instagram-photos.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Instagram / Photo Sharing domain

This case study examines **Design Instagram / Photo Sharing** — a system type commonly built at Meta and similar organizations. Design a scalable system for: **Instagram / Photo Sharing**.
...
|----------|-------------|---------------------|
| Must | Core features for instagram / photo sharing | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | feed + stories | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 500M DAU |
| 2 | Read vs write ratio? | S3+CDN |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Instagram / Photo Sharing.  
...
Design a scalable system for: **Instagram / Photo Sharing**.
...
**MVP success criteria for Design Instagram / Photo Sharing:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Instagram / Photo Sharing**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for instagram / photo sharing. We're targeting 500M DAU with a S3+CDN pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is feed + stories. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Leading products in the Design Instagram / Photo Sharing domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q03-instagram-photos.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q03-instagram-photos.md)
