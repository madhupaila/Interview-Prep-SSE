# Design WhatsApp / Messenger — Case Study

**Case Study ID:** CS-HLD-C04
**Track:** Classic HLD
**Companies:** Meta, Google
**Difficulty:** Hard
**Related question:** [Q04-whatsapp-messenger.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q04-whatsapp-messenger.md)
**Paired case study:** [CS-PAIR-05-whatsapp-messenger.md](../../paired/CS-PAIR-05-whatsapp-messenger.md)

---

## Part 1 — Business Context

**Industry analog:** WhatsApp and iMessage — 1:1 messaging at billions scale

This case study examines **Design WhatsApp / Messenger** — a system type commonly built at Meta and similar organizations. Design a scalable system for: **WhatsApp / Messenger**.
...
|----------|-------------|---------------------|
| Must | Core features for whatsapp / messenger | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | WebSocket delivery | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 2B users |
| 2 | Read vs write ratio? | E2E optional |
...
| 7 | MVP scope? | Core WebSocket delivery |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design WhatsApp / Messenger.  
...
```
Client ↔ WebSocket Gateway ↔ Chat Service → Cassandra
                              ↓
                           Kafka → Push Workers
```
...
**MVP success criteria for Design WhatsApp / Messenger:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design WhatsApp / Messenger**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for whatsapp / messenger. We're targeting 2B users with a E2E optional pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is WebSocket delivery. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | WhatsApp and iMessage — 1:1 messaging at billions scale (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q04-whatsapp-messenger.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q04-whatsapp-messenger.md)
- **End-to-end pair:** [CS-PAIR-05-whatsapp-messenger.md](../../paired/CS-PAIR-05-whatsapp-messenger.md)
