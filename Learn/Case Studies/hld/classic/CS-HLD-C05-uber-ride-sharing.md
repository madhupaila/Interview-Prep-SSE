# Design Uber / Ride Sharing — Case Study

**Case Study ID:** CS-HLD-C05
**Track:** Classic HLD
**Companies:** Uber, Lyft
**Difficulty:** Hard
**Related question:** [Q05-uber-ride-sharing.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q05-uber-ride-sharing.md)
**Paired case study:** [CS-PAIR-12-uber-ride-sharing.md](../../paired/CS-PAIR-12-uber-ride-sharing.md)

---

## Part 1 — Business Context

**Industry analog:** Uber and Lyft — real-time matching and trip lifecycle

This case study examines **Design Uber / Ride Sharing** — a system type commonly built at Uber and similar organizations. Design a scalable system for: **Uber / Ride Sharing**.
...
|----------|-------------|---------------------|
| Must | Core features for uber / ride sharing | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | surge pricing | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 100M rides/month |
| 2 | Read vs write ratio? | matching |
...
| 7 | MVP scope? | Core surge pricing |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Uber / Ride Sharing.  
...
```
Client → API → Matching Service → Geo Index (Redis/PostGIS)
              → Trip/Order DB → Notification Service
```
...
**MVP success criteria for Design Uber / Ride Sharing:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Uber / Ride Sharing**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for uber / ride sharing. We're targeting 100M rides/month with a matching pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is surge pricing. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Uber and Lyft — real-time matching and trip lifecycle (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q05-uber-ride-sharing.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q05-uber-ride-sharing.md)
- **End-to-end pair:** [CS-PAIR-12-uber-ride-sharing.md](../../paired/CS-PAIR-12-uber-ride-sharing.md)
