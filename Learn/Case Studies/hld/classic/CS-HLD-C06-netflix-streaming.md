# Design Netflix Video Streaming — Case Study

**Case Study ID:** CS-HLD-C06
**Track:** Classic HLD
**Companies:** Netflix, Amazon
**Difficulty:** Medium
**Related question:** [Q06-netflix-streaming.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q06-netflix-streaming.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Netflix Video Streaming domain

This case study examines **Design Netflix Video Streaming** — a system type commonly built at Netflix and similar organizations. Design a scalable system for: **Netflix Video Streaming**.
...
|----------|-------------|---------------------|
| Must | Core features for netflix video streaming | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | adaptive bitrate | Verified in integration tests |
...
| 7 | MVP scope? | Core adaptive bitrate |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Netflix Video Streaming.  
...
Design a scalable system for: **Netflix Video Streaming**.
...
**MVP success criteria for Design Netflix Video Streaming:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Netflix Video Streaming**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for netflix video streaming. We're targeting 200M subs with a CDN pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is adaptive bitrate. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Leading products in the Design Netflix Video Streaming domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q06-netflix-streaming.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q06-netflix-streaming.md)
