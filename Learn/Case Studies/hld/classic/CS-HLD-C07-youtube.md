# Design YouTube — Case Study

**Case Study ID:** CS-HLD-C07
**Track:** Classic HLD
**Companies:** Google, Amazon
**Difficulty:** Medium
**Related question:** [Q07-youtube.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q07-youtube.md)

---

## Part 1 — Business Context

**Industry analog:** YouTube upload, transcode, and CDN delivery

This case study examines **Design YouTube** — a system type commonly built at Google and similar organizations. Design a scalable system for: **YouTube**.
...
|----------|-------------|---------------------|
| Must | Core features for youtube | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | recommendations | Verified in integration tests |
...
| 2 | Read vs write ratio? | upload+transcode |
...
| 7 | MVP scope? | Core recommendations |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design YouTube.  
...
|--------|----------|
| Scale | 2B users |
| Traffic pattern | upload+transcode |
...
Design a scalable system for: **YouTube**.
...
**MVP success criteria for Design YouTube:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design YouTube**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for youtube. We're targeting 2B users with a upload+transcode pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is recommendations. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | YouTube upload, transcode, and CDN delivery (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q07-youtube.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q07-youtube.md)
