# Design Dropbox / File Storage — Case Study

**Case Study ID:** CS-HLD-C08
**Track:** Classic HLD
**Companies:** Dropbox, Google
**Difficulty:** Medium
**Related question:** [Q08-dropbox-storage.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q08-dropbox-storage.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Dropbox / File Storage domain

This case study examines **Design Dropbox / File Storage** — a system type commonly built at Dropbox and similar organizations. Design a scalable system for: **Dropbox / File Storage**.
...
|----------|-------------|---------------------|
| Must | Core features for dropbox / file storage | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | chunked upload | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 500M users |
| 2 | Read vs write ratio? | sync+conflict |
...
| 7 | MVP scope? | Core chunked upload |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Dropbox / File Storage.  
...
Design a scalable system for: **Dropbox / File Storage**.
...
```
Client → Sync API → Metadata DB + Blob Storage (S3)
...
**MVP success criteria for Design Dropbox / File Storage:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Dropbox / File Storage**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for dropbox / file storage. We're targeting 500M users with a sync+conflict pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is chunked upload. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Leading products in the Design Dropbox / File Storage domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q08-dropbox-storage.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q08-dropbox-storage.md)
