# Design Web Crawler — Case Study

**Case Study ID:** CS-HLD-C09
**Track:** Classic HLD
**Companies:** Google, Microsoft
**Difficulty:** Medium
**Related question:** [Q09-web-crawler.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q09-web-crawler.md)
**Paired case study:** [CS-PAIR-19-web-crawler.md](../../paired/CS-PAIR-19-web-crawler.md)
...
**MVP success criteria for Design Web Crawler:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Web Crawler**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for web crawler. We're targeting 1B pages with a BFS frontier pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is bloom filter politeness. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Googlebot crawl frontier and politeness (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q09-web-crawler.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q09-web-crawler.md)
- **End-to-end pair:** [CS-PAIR-19-web-crawler.md](../../paired/CS-PAIR-19-web-crawler.md)
