# Design Typeahead / Autocomplete — Case Study

**Case Study ID:** CS-HLD-C10
**Track:** Classic HLD
**Companies:** Google, Amazon
**Difficulty:** Hard
**Related question:** [Q10-typeahead-autocomplete.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q10-typeahead-autocomplete.md)

---

## Part 1 — Business Context

**Industry analog:** Google search suggest and Trie prefix index

This case study examines **Design Typeahead / Autocomplete** — a system type commonly built at Google and similar organizations. Design a scalable system for: **Typeahead / Autocomplete**.
...
|----------|-------------|---------------------|
| Must | Core features for typeahead / autocomplete | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | personalization | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 10B suggestions/day |
| 2 | Read vs write ratio? | trie/prefix |
...
| 7 | MVP scope? | Core personalization |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Typeahead / Autocomplete.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 10B suggestions/day |
| Traffic pattern | trie/prefix |
...
Design a scalable system for: **Typeahead / Autocomplete**.
...
**MVP success criteria for Design Typeahead / Autocomplete:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Typeahead / Autocomplete**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for typeahead / autocomplete. We're targeting 10B suggestions/day with a trie/prefix pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is personalization. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Google search suggest and Trie prefix index (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q10-typeahead-autocomplete.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q10-typeahead-autocomplete.md)
