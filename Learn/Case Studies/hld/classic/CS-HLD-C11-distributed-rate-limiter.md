# Design Distributed Rate Limiter — Case Study

**Case Study ID:** CS-HLD-C11
**Track:** Classic HLD
**Companies:** Stripe, Cloudflare
**Difficulty:** Medium
**Related question:** [Q11-distributed-rate-limiter.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q11-distributed-rate-limiter.md)
**Paired case study:** [CS-PAIR-18-distributed-rate-limiter.md](../../paired/CS-PAIR-18-distributed-rate-limiter.md)
...
**MVP success criteria for Design Distributed Rate Limiter:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Distributed Rate Limiter**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for distributed rate limiter. We're targeting 1M API keys with a token bucket pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is Redis sliding window. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
- **Question file:** [Q11-distributed-rate-limiter.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q11-distributed-rate-limiter.md)
