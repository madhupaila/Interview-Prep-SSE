# Design Notification System — Case Study

**Case Study ID:** CS-HLD-C14
**Track:** Classic HLD
**Companies:** LinkedIn, Meta
**Difficulty:** Medium
**Related question:** [Q14-notification-system.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q14-notification-system.md)
**Paired case study:** [CS-PAIR-13-notification-system.md](../../paired/CS-PAIR-13-notification-system.md)

---

## Part 1 — Business Context

**Industry analog:** Twilio and Firebase Cloud Messaging

This case study examines **Design Notification System** — a system type commonly built at LinkedIn and similar organizations. Design a scalable system for: **Notification System**.
...
|----------|-------------|---------------------|
| Must | Core features for notification system | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | preference center | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1B notifications/day |
| 2 | Read vs write ratio? | multi-channel |
...
| 7 | MVP scope? | Core preference center |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Notification System.  
...
```
Producer → Queue → Workers → Email/Push/SMS providers
         Preference DB + dedup
```
...
**MVP success criteria for Design Notification System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Notification System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for notification system. We're targeting 1B notifications/day with a multi-channel pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is preference center. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Twilio and Firebase Cloud Messaging (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q14-notification-system.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q14-notification-system.md)
- **End-to-end pair:** [CS-PAIR-13-notification-system.md](../../paired/CS-PAIR-13-notification-system.md)
