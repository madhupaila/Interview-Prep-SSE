# Design News Aggregator — Case Study

**Case Study ID:** CS-HLD-C15
**Track:** Classic HLD
**Companies:** Google, Apple
**Difficulty:** Hard
**Related question:** [Q15-news-aggregator.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q15-news-aggregator.md)

---

## Part 1 — Business Context

**Industry analog:** Google News and Apple News ranking

This case study examines **Design News Aggregator** — a system type commonly built at Google and similar organizations. Design a scalable system for: **News Aggregator**.
...
|----------|-------------|---------------------|
| Must | Core features for news aggregator | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 50M DAU |
| 2 | Read vs write ratio? | RSS+crawl |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design News Aggregator.  
...
Design a scalable system for: **News Aggregator**.
...
```
Write: Post → DB → Kafka → Fanout Workers → Redis Timelines
Read: Client → Feed API → Redis (precomputed) → merge celebrities from DB
```
...
**MVP success criteria for Design News Aggregator:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design News Aggregator**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for news aggregator. We're targeting 50M DAU with a RSS+crawl pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
| Capability | Google News and Apple News ranking (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q15-news-aggregator.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q15-news-aggregator.md)
