# Design Yelp / Nearby Places — Case Study

**Case Study ID:** CS-HLD-C16
**Track:** Classic HLD
**Companies:** Google, Uber
**Difficulty:** Hard
**Related question:** [Q16-yelp-nearby-places.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q16-yelp-nearby-places.md)

---

## Part 1 — Business Context

**Industry analog:** Yelp geo search and reviews

This case study examines **Design Yelp / Nearby Places** — a system type commonly built at Google and similar organizations. Design a scalable system for: **Yelp / Nearby Places**.
...
|----------|-------------|---------------------|
| Must | Core features for yelp / nearby places | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | reviews ranking | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 100M POIs |
| 2 | Read vs write ratio? | geohash search |
...
| 7 | MVP scope? | Core reviews ranking |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Yelp / Nearby Places.  
...
|--------|----------|
| Scale | 100M POIs |
| Traffic pattern | geohash search |
...
Design a scalable system for: **Yelp / Nearby Places**.
...
**MVP success criteria for Design Yelp / Nearby Places:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Yelp / Nearby Places**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for yelp / nearby places. We're targeting 100M POIs with a geohash search pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is reviews ranking. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Yelp geo search and reviews (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q16-yelp-nearby-places.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q16-yelp-nearby-places.md)
