# Design Ticketmaster / Booking — Case Study

**Case Study ID:** CS-HLD-C17
**Track:** Classic HLD
**Companies:** Ticketmaster, Airbnb
**Difficulty:** Medium
**Related question:** [Q17-ticketmaster-booking.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q17-ticketmaster-booking.md)

---

## Part 1 — Business Context

**Industry analog:** Ticketmaster seat locking and inventory

This case study examines **Design Ticketmaster / Booking** — a system type commonly built at Ticketmaster and similar organizations. Design a scalable system for: **Ticketmaster / Booking**.
...
|----------|-------------|---------------------|
| Must | Core features for ticketmaster / booking | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | queue for sales | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | hot events |
| 2 | Read vs write ratio? | inventory lock |
...
| 7 | MVP scope? | Core queue for sales |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Ticketmaster / Booking.  
...
|--------|----------|
| Scale | hot events |
| Traffic pattern | inventory lock |
...
Design a scalable system for: **Ticketmaster / Booking**.
...
```
Client → API → Inventory Service (optimistic lock) → Booking DB → Payment
```
...
**MVP success criteria for Design Ticketmaster / Booking:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Ticketmaster / Booking**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for ticketmaster / booking. We're targeting hot events with a inventory lock pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is queue for sales. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Ticketmaster seat locking and inventory (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q17-ticketmaster-booking.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q17-ticketmaster-booking.md)
