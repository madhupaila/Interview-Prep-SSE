# Design E-Commerce (Amazon) — Case Study

**Case Study ID:** CS-HLD-C18
**Track:** Classic HLD
**Companies:** Amazon, Walmart
**Difficulty:** Medium
**Related question:** [Q18-ecommerce-amazon.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q18-ecommerce-amazon.md)

---

## Part 1 — Business Context

**Industry analog:** Amazon catalog, cart, and checkout

This case study examines **Design E-Commerce (Amazon)** — a system type commonly built at Amazon and similar organizations. Design a scalable system for: **E-Commerce (Amazon)**.
...
|----------|-------------|---------------------|
| Must | Core features for e-commerce (amazon) | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | inventory reservation | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 300M users |
| 2 | Read vs write ratio? | catalog+cart+order |
...
| 7 | MVP scope? | Core inventory reservation |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design E-Commerce (Amazon).  
...
|--------|----------|
| Scale | 300M users |
| Traffic pattern | catalog+cart+order |
...
Design a scalable system for: **E-Commerce (Amazon)**.
...
```
Client → API → Catalog/Cart/Order Services → DB + Inventory Cache
```
...
**MVP success criteria for Design E-Commerce (Amazon):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design E-Commerce (Amazon)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for e-commerce (amazon). We're targeting 300M users with a catalog+cart+order pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is inventory reservation. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Amazon catalog, cart, and checkout (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q18-ecommerce-amazon.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q18-ecommerce-amazon.md)
