# Design Payment System (Stripe) — Case Study

**Case Study ID:** CS-HLD-C19
**Track:** Classic HLD
**Companies:** Stripe, PayPal
**Difficulty:** Hard
**Related question:** [Q19-payment-system-stripe.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q19-payment-system-stripe.md)

---

## Part 1 — Business Context

**Industry analog:** Stripe Payment Intents and idempotent APIs

This case study examines **Design Payment System (Stripe)** — a system type commonly built at Stripe and similar organizations. Design a scalable system for: **Payment System (Stripe)**.
...
|----------|-------------|---------------------|
| Must | Core features for payment system (stripe) | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | ledger pattern | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1M merchants |
| 2 | Read vs write ratio? | idempotency |
...
| 7 | MVP scope? | Core ledger pattern |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Payment System (Stripe).  
...
Design a scalable system for: **Payment System (Stripe)**.
...
**MVP success criteria for Design Payment System (Stripe):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Payment System (Stripe)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for payment system (stripe). We're targeting 1M merchants with a idempotency pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is ledger pattern. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Stripe Payment Intents and idempotent APIs (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q19-payment-system-stripe.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q19-payment-system-stripe.md)
