# Design Distributed Job Scheduler — Case Study

**Case Study ID:** CS-HLD-C20
**Track:** Classic HLD
**Companies:** Airbnb, LinkedIn
**Difficulty:** Medium
**Related question:** [Q20-distributed-job-scheduler.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q20-distributed-job-scheduler.md)

---

## Part 1 — Business Context

**Industry analog:** Airflow and Quartz distributed scheduling

This case study examines **Design Distributed Job Scheduler** — a system type commonly built at Airbnb and similar organizations. Design a scalable system for: **Distributed Job Scheduler**.
...
|----------|-------------|---------------------|
| Must | Core features for distributed job scheduler | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | exactly-once execution | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1M jobs/day |
| 2 | Read vs write ratio? | priority queue |
...
| 7 | MVP scope? | Core exactly-once execution |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Distributed Job Scheduler.  
...
|--------|----------|
| Scale | 1M jobs/day |
| Traffic pattern | priority queue |
...
Design a scalable system for: **Distributed Job Scheduler**.
...
**MVP success criteria for Design Distributed Job Scheduler:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Distributed Job Scheduler**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for distributed job scheduler. We're targeting 1M jobs/day with a priority queue pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is exactly-once execution. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Airflow and Quartz distributed scheduling (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q20-distributed-job-scheduler.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q20-distributed-job-scheduler.md)
