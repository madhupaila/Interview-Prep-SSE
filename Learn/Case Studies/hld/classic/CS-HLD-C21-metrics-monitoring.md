# Design Metrics / Monitoring System — Case Study

**Case Study ID:** CS-HLD-C21
**Track:** Classic HLD
**Companies:** Datadog, Google
**Difficulty:** Medium
**Related question:** [Q21-metrics-monitoring.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q21-metrics-monitoring.md)

---

## Part 1 — Business Context

**Industry analog:** Datadog and Prometheus/Grafana

This case study examines **Design Metrics / Monitoring System** — a system type commonly built at Datadog and similar organizations. Design a scalable system for: **Metrics / Monitoring System**.
...
|----------|-------------|---------------------|
| Must | Core features for metrics / monitoring system | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | alerting rules | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1M metrics/sec |
| 2 | Read vs write ratio? | time-series DB |
...
| 7 | MVP scope? | Core alerting rules |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Metrics / Monitoring System.  
...
| Traffic pattern | time-series DB |
...
Design a scalable system for: **Metrics / Monitoring System**.
...
```
Agents → Collectors → Message Queue → Storage → Query API → Dashboards
```
...
**MVP success criteria for Design Metrics / Monitoring System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Metrics / Monitoring System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for metrics / monitoring system. We're targeting 1M metrics/sec with a time-series DB pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is alerting rules. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Datadog and Prometheus/Grafana (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q21-metrics-monitoring.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q21-metrics-monitoring.md)
