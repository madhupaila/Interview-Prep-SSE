# Design Logging System — Case Study

**Case Study ID:** CS-HLD-C22
**Track:** Classic HLD
**Companies:** Splunk, Elastic
**Difficulty:** Medium
**Related question:** [Q22-logging-system.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q22-logging-system.md)

---

## Part 1 — Business Context

**Industry analog:** Splunk and ELK stack ingestion

This case study examines **Design Logging System** — a system type commonly built at Splunk and similar organizations. Design a scalable system for: **Logging System**.
...
|----------|-------------|---------------------|
| Must | Core features for logging system | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | retention tiers | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 10M logs/sec |
| 2 | Read vs write ratio? | ELK stack |
...
| 7 | MVP scope? | Core retention tiers |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Logging System.  
...
Design a scalable system for: **Logging System**.
...
**MVP success criteria for Design Logging System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Logging System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for logging system. We're targeting 10M logs/sec with a ELK stack pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is retention tiers. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Splunk and ELK stack ingestion (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q22-logging-system.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q22-logging-system.md)
