# Design CDN — Case Study

**Case Study ID:** CS-HLD-C23
**Track:** Classic HLD
**Companies:** Cloudflare, Akamai
**Difficulty:** Medium
**Related question:** [Q23-cdn-design.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q23-cdn-design.md)

---

## Part 1 — Business Context

**Industry analog:** CloudFront and Akamai edge caching

This case study examines **Design CDN** — a system type commonly built at Cloudflare and similar organizations. Design a scalable system for: **CDN**.
...
|----------|-------------|---------------------|
| Must | Core features for cdn | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | origin shield | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | global |
| 2 | Read vs write ratio? | edge caching |
...
| 7 | MVP scope? | Core origin shield |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design CDN.  
...
Design a scalable system for: **CDN**.
...
```
Client → LB → API Gateway → Services → Cache → Database
```
...
**MVP success criteria for Design CDN:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design CDN**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for cdn. We're targeting global with a edge caching pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is origin shield. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | CloudFront and Akamai edge caching (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q23-cdn-design.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q23-cdn-design.md)
