# Design API Gateway — Case Study

**Case Study ID:** CS-HLD-C24
**Track:** Classic HLD
**Companies:** Kong, AWS
**Difficulty:** Medium
**Related question:** [Q24-api-gateway.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q24-api-gateway.md)

---

## Part 1 — Business Context

**Industry analog:** Kong and AWS API Gateway

This case study examines **Design API Gateway** — a system type commonly built at Kong and similar organizations. Design a scalable system for: **API Gateway**.
...
|----------|-------------|---------------------|
| Must | Core features for api gateway | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | request transformation | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1M developers |
| 2 | Read vs write ratio? | auth+rate limit |
...
| 7 | MVP scope? | Core request transformation |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design API Gateway.  
...
|--------|----------|
| Scale | 1M developers |
| Traffic pattern | auth+rate limit |
...
Design a scalable system for: **API Gateway**.
...
**MVP success criteria for Design API Gateway:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design API Gateway**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for api gateway. We're targeting 1M developers with a auth+rate limit pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is request transformation. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Kong and AWS API Gateway (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q24-api-gateway.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q24-api-gateway.md)
