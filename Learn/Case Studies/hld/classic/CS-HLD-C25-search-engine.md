# Design Search Engine — Case Study

**Case Study ID:** CS-HLD-C25
**Track:** Classic HLD
**Companies:** Google, Microsoft
**Difficulty:** Hard
**Related question:** [Q25-search-engine.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q25-search-engine.md)
...
This case study examines **Design Search Engine** — a system type commonly built at Google and similar organizations. Design a scalable system for: **Search Engine**.
...
|----------|-------------|---------------------|
| Must | Core features for search engine | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | PageRank basics | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Search Engine.  
...
**MVP success criteria for Design Search Engine:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Search Engine**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
- **Question file:** [Q25-search-engine.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q25-search-engine.md)
