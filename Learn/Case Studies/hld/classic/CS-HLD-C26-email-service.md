# Design Email Service — Case Study

**Case Study ID:** CS-HLD-C26
**Track:** Classic HLD
**Companies:** Google, Microsoft
**Difficulty:** Medium
**Related question:** [Q26-email-service.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q26-email-service.md)

---

## Part 1 — Business Context

**Industry analog:** Gmail SMTP ingestion and storage

This case study examines **Design Email Service** — a system type commonly built at Google and similar organizations. Design a scalable system for: **Email Service**.
...
|----------|-------------|---------------------|
| Must | Core features for email service | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | spam filter | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1B emails/day |
| 2 | Read vs write ratio? | SMTP queue |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Email Service.  
...
Design a scalable system for: **Email Service**.
...
**MVP success criteria for Design Email Service:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Email Service**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for email service. We're targeting 1B emails/day with a SMTP queue pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is spam filter. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Gmail SMTP ingestion and storage (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q26-email-service.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q26-email-service.md)
