# Design Google Docs (Collaborative) — Case Study

**Case Study ID:** CS-HLD-C27
**Track:** Classic HLD
**Companies:** Google, Figma
**Difficulty:** Medium
**Related question:** [Q27-google-docs-collab.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q27-google-docs-collab.md)

---

## Part 1 — Business Context

**Industry analog:** Google Docs OT/CRDT operational transform

This case study examines **Design Google Docs (Collaborative)** — a system type commonly built at Google and similar organizations. Design a scalable system for: **Google Docs (Collaborative)**.
...
|----------|-------------|---------------------|
| Must | Core features for google docs (collaborative) | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | WebSocket sync | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | real-time |
| 2 | Read vs write ratio? | OT/CRDT |
...
| 7 | MVP scope? | Core WebSocket sync |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Google Docs (Collaborative).  
...
Design a scalable system for: **Google Docs (Collaborative)**.
...
```
Client ↔ WebSocket ↔ Collaboration Server (OT/CRDT) ↔ Document Store
```
...
**MVP success criteria for Design Google Docs (Collaborative):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Google Docs (Collaborative)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for google docs (collaborative). We're targeting real-time with a OT/CRDT pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is WebSocket sync. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Google Docs OT/CRDT operational transform (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q27-google-docs-collab.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q27-google-docs-collab.md)
