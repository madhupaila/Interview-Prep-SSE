# Design Zoom / Video Conferencing — Case Study

**Case Study ID:** CS-HLD-C28
**Track:** Classic HLD
**Companies:** Zoom, Google
**Difficulty:** Medium
**Related question:** [Q28-zoom-video-conferencing.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q28-zoom-video-conferencing.md)

---

## Part 1 — Business Context

**Industry analog:** Zoom SFU/MCU and signaling

This case study examines **Design Zoom / Video Conferencing** — a system type commonly built at Zoom and similar organizations. Design a scalable system for: **Zoom / Video Conferencing**.
...
|----------|-------------|---------------------|
| Must | Core features for zoom / video conferencing | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | recording | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 300M meeting-min/day |
| 2 | Read vs write ratio? | SFU architecture |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Zoom / Video Conferencing.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 300M meeting-min/day |
| Traffic pattern | SFU architecture |
...
**MVP success criteria for Design Zoom / Video Conferencing:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Zoom / Video Conferencing**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for zoom / video conferencing. We're targeting 300M meeting-min/day with a SFU architecture pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is recording. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Zoom SFU/MCU and signaling (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q28-zoom-video-conferencing.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q28-zoom-video-conferencing.md)
