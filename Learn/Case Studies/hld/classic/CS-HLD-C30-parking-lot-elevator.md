# Design Parking Lot / Elevator — Case Study

**Case Study ID:** CS-HLD-C30
**Track:** Classic HLD
**Companies:** Amazon, Microsoft
**Difficulty:** Medium
**Related question:** [Q30-parking-lot-elevator.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q30-parking-lot-elevator.md)
...
**MVP success criteria for Design Parking Lot / Elevator:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Parking Lot / Elevator**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for parking lot / elevator. We're targeting local scale with a state machine pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is OOD+HLD bridge. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Otis elevator dispatch and smart parking platforms (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q30-parking-lot-elevator.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q30-parking-lot-elevator.md)
