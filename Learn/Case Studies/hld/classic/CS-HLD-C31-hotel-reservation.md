# Design Hotel Reservation — Case Study

**Case Study ID:** CS-HLD-C31
**Track:** Classic HLD
**Companies:** Airbnb, Booking
**Difficulty:** Medium
**Related question:** [Q31-hotel-reservation.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q31-hotel-reservation.md)

---

## Part 1 — Business Context

**Industry analog:** Booking.com availability and overbooking

This case study examines **Design Hotel Reservation** — a system type commonly built at Airbnb and similar organizations. Design a scalable system for: **Hotel Reservation**.
...
|----------|-------------|---------------------|
| Must | Core features for hotel reservation | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | overbooking policy | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | inventory |
| 2 | Read vs write ratio? | optimistic lock |
...
| 7 | MVP scope? | Core overbooking policy |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Hotel Reservation.  
...
|--------|----------|
| Scale | inventory |
| Traffic pattern | optimistic lock |
...
Design a scalable system for: **Hotel Reservation**.
...
**MVP success criteria for Design Hotel Reservation:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Hotel Reservation**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for hotel reservation. We're targeting inventory with a optimistic lock pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is overbooking policy. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Booking.com availability and overbooking (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q31-hotel-reservation.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q31-hotel-reservation.md)
