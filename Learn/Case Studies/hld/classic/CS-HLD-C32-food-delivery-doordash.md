# Design Food Delivery (DoorDash) — Case Study

**Case Study ID:** CS-HLD-C32
**Track:** Classic HLD
**Companies:** DoorDash, Uber
**Difficulty:** Hard
**Related question:** [Q32-food-delivery-doordash.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q32-food-delivery-doordash.md)

---

## Part 1 — Business Context

**Industry analog:** DoorDash dispatch and ETA prediction

This case study examines **Design Food Delivery (DoorDash)** — a system type commonly built at DoorDash and similar organizations. Design a scalable system for: **Food Delivery (DoorDash)**.
...
|----------|-------------|---------------------|
| Must | Core features for food delivery (doordash) | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | ETA prediction | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 3-sided marketplace |
| 2 | Read vs write ratio? | dispatch |
...
| 7 | MVP scope? | Core ETA prediction |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Food Delivery (DoorDash).  
...
| Metric | Estimate |
|--------|----------|
| Scale | 3-sided marketplace |
| Traffic pattern | dispatch |
...
Design a scalable system for: **Food Delivery (DoorDash)**.
...
**MVP success criteria for Design Food Delivery (DoorDash):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Food Delivery (DoorDash)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for food delivery (doordash). We're targeting 3-sided marketplace with a dispatch pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is ETA prediction. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | DoorDash dispatch and ETA prediction (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q32-food-delivery-doordash.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q32-food-delivery-doordash.md)
