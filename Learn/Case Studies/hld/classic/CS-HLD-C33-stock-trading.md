# Design Stock Trading Platform — Case Study

**Case Study ID:** CS-HLD-C33
**Track:** Classic HLD
**Companies:** Robinhood, Bloomberg
**Difficulty:** Hard
**Related question:** [Q33-stock-trading.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q33-stock-trading.md)

---

## Part 1 — Business Context

**Industry analog:** Robinhood and NASDAQ matching engine patterns

This case study examines **Design Stock Trading Platform** — a system type commonly built at Robinhood and similar organizations. Design a scalable system for: **Stock Trading Platform**.
...
|----------|-------------|---------------------|
| Must | Core features for stock trading platform | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | matching engine | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | low latency |
| 2 | Read vs write ratio? | order book |
...
| 7 | MVP scope? | Core matching engine |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Stock Trading Platform.  
...
Design a scalable system for: **Stock Trading Platform**.
...
```
Client → API Gateway → Payment Service → Ledger DB (ACID)
...
**MVP success criteria for Design Stock Trading Platform:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Stock Trading Platform**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for stock trading platform. We're targeting low latency with a order book pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is matching engine. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Robinhood and NASDAQ matching engine patterns (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q33-stock-trading.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q33-stock-trading.md)
