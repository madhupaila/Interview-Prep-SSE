# Design Ad Click Aggregator — Case Study

**Case Study ID:** CS-HLD-C34
**Track:** Classic HLD
**Companies:** Google, Meta
**Difficulty:** Medium
**Related question:** [Q34-ad-click-aggregator.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q34-ad-click-aggregator.md)

---

## Part 1 — Business Context

**Industry analog:** Google Ads real-time click aggregation

This case study examines **Design Ad Click Aggregator** — a system type commonly built at Google and similar organizations. Design a scalable system for: **Ad Click Aggregator**.
...
|----------|-------------|---------------------|
| Must | Core features for ad click aggregator | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | lambda architecture | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1M clicks/sec |
| 2 | Read vs write ratio? | stream agg |
...
| 7 | MVP scope? | Core lambda architecture |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Ad Click Aggregator.  
...
Design a scalable system for: **Ad Click Aggregator**.
...
**MVP success criteria for Design Ad Click Aggregator:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Ad Click Aggregator**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for ad click aggregator. We're targeting 1M clicks/sec with a stream agg pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is lambda architecture. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Google Ads real-time click aggregation (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q34-ad-click-aggregator.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q34-ad-click-aggregator.md)
