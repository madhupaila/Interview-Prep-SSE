# Design Web Analytics (Google Analytics) — Case Study

**Case Study ID:** CS-HLD-C35
**Track:** Classic HLD
**Companies:** Google, Adobe
**Difficulty:** Medium
**Related question:** [Q35-web-analytics.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q35-web-analytics.md)

---

## Part 1 — Business Context

**Industry analog:** Google Analytics event pipeline

This case study examines **Design Web Analytics (Google Analytics)** — a system type commonly built at Google and similar organizations. Design a scalable system for: **Web Analytics (Google Analytics)**.
...
|----------|-------------|---------------------|
| Must | Core features for web analytics (google analytics) | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | real-time dashboard | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1T events/day |
| 2 | Read vs write ratio? | sketch structures |
...
| 7 | MVP scope? | Core real-time dashboard |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Web Analytics (Google Analytics).  
...
|--------|----------|
| Scale | 1T events/day |
| Traffic pattern | sketch structures |
...
Design a scalable system for: **Web Analytics (Google Analytics)**.
...
**MVP success criteria for Design Web Analytics (Google Analytics):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Web Analytics (Google Analytics)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for web analytics (google analytics). We're targeting 1T events/day with a sketch structures pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is real-time dashboard. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Google Analytics event pipeline (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q35-web-analytics.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q35-web-analytics.md)
