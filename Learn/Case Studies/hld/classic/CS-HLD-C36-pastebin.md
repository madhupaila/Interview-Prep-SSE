# Design Pastebin — Case Study

**Case Study ID:** CS-HLD-C36
**Track:** Classic HLD
**Companies:** Dropbox, Google
**Difficulty:** Medium
**Related question:** [Q36-pastebin.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q36-pastebin.md)

---

## Part 1 — Business Context

**Industry analog:** Pastebin and GitHub Gist — text share with TTL

This case study examines **Design Pastebin** — a system type commonly built at Dropbox and similar organizations. Design a scalable system for: **Pastebin**.
...
|----------|-------------|---------------------|
| Must | Core features for pastebin | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | abuse detection | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 10M pastes/day |
| 2 | Read vs write ratio? | TTL content |
...
| 7 | MVP scope? | Core abuse detection |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Pastebin.  
...
Design a scalable system for: **Pastebin**.
...
**MVP success criteria for Design Pastebin:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Pastebin**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for pastebin. We're targeting 10M pastes/day with a TTL content pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is abuse detection. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Pastebin and GitHub Gist — text share with TTL (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q36-pastebin.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q36-pastebin.md)
