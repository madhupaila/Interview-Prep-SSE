# Design Tinder / Dating App — Case Study

**Case Study ID:** CS-HLD-C38
**Track:** Classic HLD
**Companies:** Match, Bumble
**Difficulty:** Hard
**Related question:** [Q38-tinder-dating.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q38-tinder-dating.md)

---

## Part 1 — Business Context

**Industry analog:** Tinder geo sharding and swipe queue

This case study examines **Design Tinder / Dating App** — a system type commonly built at Match and similar organizations. Design a scalable system for: **Tinder / Dating App**.
...
|----------|-------------|---------------------|
| Must | Core features for tinder / dating app | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | mutual match notify | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 50M users |
| 2 | Read vs write ratio? | swipe queue |
...
| 7 | MVP scope? | Core mutual match notify |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Tinder / Dating App.  
...
Design a scalable system for: **Tinder / Dating App**.
...
**MVP success criteria for Design Tinder / Dating App:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Tinder / Dating App**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for tinder / dating app. We're targeting 50M users with a swipe queue pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is mutual match notify. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Tinder geo sharding and swipe queue (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q38-tinder-dating.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q38-tinder-dating.md)
