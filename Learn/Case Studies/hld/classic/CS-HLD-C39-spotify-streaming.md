# Design Spotify Music Streaming — Case Study

**Case Study ID:** CS-HLD-C39
**Track:** Classic HLD
**Companies:** Spotify, Apple
**Difficulty:** Medium
**Related question:** [Q39-spotify-streaming.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q39-spotify-streaming.md)

---

## Part 1 — Business Context

**Industry analog:** Spotify recommendation and streaming

This case study examines **Design Spotify Music Streaming** — a system type commonly built at Spotify and similar organizations. Design a scalable system for: **Spotify Music Streaming**.
...
|----------|-------------|---------------------|
| Must | Core features for spotify music streaming | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | recommendation | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 400M users |
| 2 | Read vs write ratio? | playlist |
...
| 7 | MVP scope? | Core recommendation |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Spotify Music Streaming.  
...
Design a scalable system for: **Spotify Music Streaming**.
...
**MVP success criteria for Design Spotify Music Streaming:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Spotify Music Streaming**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for spotify music streaming. We're targeting 400M users with a playlist pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is recommendation. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Spotify recommendation and streaming (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q39-spotify-streaming.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q39-spotify-streaming.md)
