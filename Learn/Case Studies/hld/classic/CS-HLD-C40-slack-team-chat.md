# Design Slack / Team Chat — Case Study

**Case Study ID:** CS-HLD-C40
**Track:** Classic HLD
**Companies:** Slack, Microsoft
**Difficulty:** Hard
**Related question:** [Q40-slack-team-chat.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q40-slack-team-chat.md)

---

## Part 1 — Business Context

**Industry analog:** Slack channels, threads, and search

This case study examines **Design Slack / Team Chat** — a system type commonly built at Slack and similar organizations. Design a scalable system for: **Slack / Team Chat**.
...
|----------|-------------|---------------------|
| Must | Core features for slack / team chat | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | search index | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 20M DAU |
| 2 | Read vs write ratio? | channels+threads |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Slack / Team Chat.  
...
|--------|----------|
| Scale | 20M DAU |
| Traffic pattern | channels+threads |
...
**MVP success criteria for Design Slack / Team Chat:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Slack / Team Chat**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for slack / team chat. We're targeting 20M DAU with a channels+threads pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is search index. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Slack channels, threads, and search (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q40-slack-team-chat.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q40-slack-team-chat.md)
