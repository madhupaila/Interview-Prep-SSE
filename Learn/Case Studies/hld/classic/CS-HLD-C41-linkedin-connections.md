# Design LinkedIn Connections — Case Study

**Case Study ID:** CS-HLD-C41
**Track:** Classic HLD
**Companies:** LinkedIn, Meta
**Difficulty:** Medium
**Related question:** [Q41-linkedin-connections.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q41-linkedin-connections.md)

---

## Part 1 — Business Context

**Industry analog:** LinkedIn BFS connection suggestions

This case study examines **Design LinkedIn Connections** — a system type commonly built at LinkedIn and similar organizations. Design a scalable system for: **LinkedIn Connections**.
...
|----------|-------------|---------------------|
| Must | Core features for linkedin connections | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | graph DB | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 900M users |
| 2 | Read vs write ratio? | BFS degrees |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design LinkedIn Connections.  
...
Design a scalable system for: **LinkedIn Connections**.
...
```
Profile → Graph Service → Graph DB (Neo4j/TigerGraph)
...
**MVP success criteria for Design LinkedIn Connections:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design LinkedIn Connections**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for linkedin connections. We're targeting 900M users with a BFS degrees pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is graph DB. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | LinkedIn BFS connection suggestions (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q41-linkedin-connections.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q41-linkedin-connections.md)
