# Design Airbnb Search + Booking — Case Study

**Case Study ID:** CS-HLD-C42
**Track:** Classic HLD
**Companies:** Airbnb, Expedia
**Difficulty:** Hard
**Related question:** [Q42-airbnb-search-booking.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q42-airbnb-search-booking.md)

---

## Part 1 — Business Context

**Industry analog:** Airbnb search ranking and booking flow

This case study examines **Design Airbnb Search + Booking** — a system type commonly built at Airbnb and similar organizations. Design a scalable system for: **Airbnb Search + Booking**.
...
|----------|-------------|---------------------|
| Must | Core features for airbnb search + booking | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | payment hold | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | geospatial filter |
| 2 | Read vs write ratio? | calendar availability |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Airbnb Search + Booking.  
...
| Metric | Estimate |
|--------|----------|
| Scale | geospatial filter |
| Traffic pattern | calendar availability |
...
**MVP success criteria for Design Airbnb Search + Booking:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Airbnb Search + Booking**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for airbnb search + booking. We're targeting geospatial filter with a calendar availability pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is payment hold. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Airbnb search ranking and booking flow (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q42-airbnb-search-booking.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q42-airbnb-search-booking.md)
