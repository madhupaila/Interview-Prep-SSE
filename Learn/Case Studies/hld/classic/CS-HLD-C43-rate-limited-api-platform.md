# Design Rate-Limited API Platform — Case Study

**Case Study ID:** CS-HLD-C43
**Track:** Classic HLD
**Companies:** Twilio, Stripe
**Difficulty:** Medium
**Related question:** [Q43-rate-limited-api-platform.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q43-rate-limited-api-platform.md)
...
**MVP success criteria for Design Rate-Limited API Platform:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Rate-Limited API Platform**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for rate-limited api platform. We're targeting developer APIs with a tiered limits pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is usage billing. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Stripe and Cloudflare — API rate limits and abuse protection (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q43-rate-limited-api-platform.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q43-rate-limited-api-platform.md)
