# Design Distributed Lock Service — Case Study

**Case Study ID:** CS-HLD-C44
**Track:** Classic HLD
**Companies:** Google, ZooKeeper
**Difficulty:** Medium
**Related question:** [Q44-distributed-lock.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q44-distributed-lock.md)

---

## Part 1 — Business Context

**Industry analog:** Chubby/ZooKeeper and Redis Redlock

This case study examines **Design Distributed Lock Service** — a system type commonly built at Google and similar organizations. Design a scalable system for: **Distributed Lock Service**.
...
|----------|-------------|---------------------|
| Must | Core features for distributed lock service | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | lease TTL | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | Chubby-style |
| 2 | Read vs write ratio? | fencing tokens |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Distributed Lock Service.  
...
|--------|----------|
| Scale | Chubby-style |
| Traffic pattern | fencing tokens |
...
Design a scalable system for: **Distributed Lock Service**.
...
**MVP success criteria for Design Distributed Lock Service:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Distributed Lock Service**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for distributed lock service. We're targeting Chubby-style with a fencing tokens pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is lease TTL. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Chubby/ZooKeeper and Redis Redlock (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q44-distributed-lock.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q44-distributed-lock.md)
