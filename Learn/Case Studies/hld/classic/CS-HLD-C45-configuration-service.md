# Design Configuration Service — Case Study

**Case Study ID:** CS-HLD-C45
**Track:** Classic HLD
**Companies:** Netflix, AWS
**Difficulty:** Medium
**Related question:** [Q45-configuration-service.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q45-configuration-service.md)

---

## Part 1 — Business Context

**Industry analog:** Netflix Archaius and Spring Cloud Config

This case study examines **Design Configuration Service** — a system type commonly built at Netflix and similar organizations. Design a scalable system for: **Configuration Service**.
...
|----------|-------------|---------------------|
| Must | Core features for configuration service | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | push vs pull | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 10K services |
| 2 | Read vs write ratio? | dynamic config |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Configuration Service.  
...
|--------|----------|
| Scale | 10K services |
| Traffic pattern | dynamic config |
...
Design a scalable system for: **Configuration Service**.
...
```
Services → Config/Flag Client → Config Server → Real-time push
```
...
**MVP success criteria for Design Configuration Service:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Configuration Service**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for configuration service. We're targeting 10K services with a dynamic config pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is push vs pull. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Netflix Archaius and Spring Cloud Config (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q45-configuration-service.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q45-configuration-service.md)
