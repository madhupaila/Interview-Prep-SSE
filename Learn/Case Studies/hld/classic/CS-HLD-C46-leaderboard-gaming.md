# Design Leaderboard / Gaming — Case Study

**Case Study ID:** CS-HLD-C46
**Track:** Classic HLD
**Companies:** EA, Activision
**Difficulty:** Medium
**Related question:** [Q46-leaderboard-gaming.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q46-leaderboard-gaming.md)

---

## Part 1 — Business Context

**Industry analog:** Redis sorted sets for real-time ranks

This case study examines **Design Leaderboard / Gaming** — a system type commonly built at EA and similar organizations. Design a scalable system for: **Leaderboard / Gaming**.
...
|----------|-------------|---------------------|
| Must | Core features for leaderboard / gaming | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | seasonal reset | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 10M players |
| 2 | Read vs write ratio? | Redis sorted set |
...
| 7 | MVP scope? | Core seasonal reset |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Leaderboard / Gaming.  
...
|--------|----------|
| Scale | 10M players |
| Traffic pattern | Redis sorted set |
...
Design a scalable system for: **Leaderboard / Gaming**.
...
```
Score events → Redis Sorted Sets → Top-N query API
```
...
**MVP success criteria for Design Leaderboard / Gaming:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Leaderboard / Gaming**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for leaderboard / gaming. We're targeting 10M players with a Redis sorted set pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is seasonal reset. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Redis sorted sets for real-time ranks (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q46-leaderboard-gaming.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q46-leaderboard-gaming.md)
