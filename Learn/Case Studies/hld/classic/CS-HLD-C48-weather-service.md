# Design Weather Service — Case Study

**Case Study ID:** CS-HLD-C48
**Track:** Classic HLD
**Companies:** Apple, Google
**Difficulty:** Medium
**Related question:** [Q48-weather-service.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q48-weather-service.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Weather Service domain

This case study examines **Design Weather Service** — a system type commonly built at Apple and similar organizations. Design a scalable system for: **Weather Service**.
...
|----------|-------------|---------------------|
| Must | Core features for weather service | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | aggregation from stations | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1B requests/day |
| 2 | Read vs write ratio? | cache by geo |
...
| 7 | MVP scope? | Core aggregation from stations |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Weather Service.  
...
Design a scalable system for: **Weather Service**.
...
```
Client → CDN Edge Cache → API → Aggregation service → upstream sources
```
...
**MVP success criteria for Design Weather Service:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Weather Service**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for weather service. We're targeting 1B requests/day with a cache by geo pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is aggregation from stations. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Leading products in the Design Weather Service domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q48-weather-service.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q48-weather-service.md)
