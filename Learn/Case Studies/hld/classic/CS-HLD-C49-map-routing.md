# Design Map / Routing (Google Maps) — Case Study

**Case Study ID:** CS-HLD-C49
**Track:** Classic HLD
**Companies:** Google, Uber
**Difficulty:** Hard
**Related question:** [Q49-map-routing.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q49-map-routing.md)

---

## Part 1 — Business Context

**Industry analog:** Google Maps routing and traffic-aware ETA

This case study examines **Design Map / Routing (Google Maps)** — a system type commonly built at Google and similar organizations. Design a scalable system for: **Map / Routing (Google Maps)**.
...
|----------|-------------|---------------------|
| Must | Core features for map / routing (google maps) | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | real-time traffic | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | global graph |
| 2 | Read vs write ratio? | A*/contraction hierarchies |
...
| 7 | MVP scope? | Core real-time traffic |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Map / Routing (Google Maps).  
...
|--------|----------|
| Scale | global graph |
| Traffic pattern | A*/contraction hierarchies |
...
Design a scalable system for: **Map / Routing (Google Maps)**.
...
**MVP success criteria for Design Map / Routing (Google Maps):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Map / Routing (Google Maps)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for map / routing (google maps). We're targeting global graph with a A*/contraction hierarchies pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is real-time traffic. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Google Maps routing and traffic-aware ETA (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q49-map-routing.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q49-map-routing.md)
