# Design Feature Flag System — Case Study

**Case Study ID:** CS-HLD-C53
**Track:** Classic HLD
**Companies:** LaunchDarkly, Netflix
**Difficulty:** Medium
**Related question:** [Q53-feature-flag-system.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q53-feature-flag-system.md)

---

## Part 1 — Business Context

**Industry analog:** LaunchDarkly and Split.io

This case study examines **Design Feature Flag System** — a system type commonly built at LaunchDarkly and similar organizations. Design a scalable system for: **Feature Flag System**.
...
|----------|-------------|---------------------|
| Must | Core features for feature flag system | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | real-time toggle | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1K flags |
| 2 | Read vs write ratio? | targeting rules |
...
| 7 | MVP scope? | Core real-time toggle |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Feature Flag System.  
...
|--------|----------|
| Scale | 1K flags |
| Traffic pattern | targeting rules |
...
Design a scalable system for: **Feature Flag System**.
...
**MVP success criteria for Design Feature Flag System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Feature Flag System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for feature flag system. We're targeting 1K flags with a targeting rules pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is real-time toggle. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | LaunchDarkly and Split.io (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q53-feature-flag-system.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q53-feature-flag-system.md)
