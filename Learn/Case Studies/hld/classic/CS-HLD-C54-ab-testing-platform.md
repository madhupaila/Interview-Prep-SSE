# Design A/B Testing Platform — Case Study

**Case Study ID:** CS-HLD-C54
**Track:** Classic HLD
**Companies:** Netflix, Meta
**Difficulty:** Medium
**Related question:** [Q54-ab-testing-platform.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q54-ab-testing-platform.md)

---

## Part 1 — Business Context

**Industry analog:** Optimizely and Google Experimentation

This case study examines **Design A/B Testing Platform** — a system type commonly built at Netflix and similar organizations. Design a scalable system for: **A/B Testing Platform**.
...
|----------|-------------|---------------------|
| Must | Core features for a/b testing platform | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | exposure logging | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1000 experiments |
| 2 | Read vs write ratio? | statistical engine |
...
| 7 | MVP scope? | Core exposure logging |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design A/B Testing Platform.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 1000 experiments |
| Traffic pattern | statistical engine |
...
Design a scalable system for: **A/B Testing Platform**.
...
```
User → Experiment Service → variant assignment → exposure log → analysis
```
...
**MVP success criteria for Design A/B Testing Platform:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design A/B Testing Platform**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for a/b testing platform. We're targeting 1000 experiments with a statistical engine pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is exposure logging. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Optimizely and Google Experimentation (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q54-ab-testing-platform.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q54-ab-testing-platform.md)
