# Design Data Pipeline / ETL — Case Study

**Case Study ID:** CS-HLD-C55
**Track:** Classic HLD
**Companies:** Databricks, Airbnb
**Difficulty:** Medium
**Related question:** [Q55-data-pipeline-etl.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q55-data-pipeline-etl.md)

---

## Part 1 — Business Context

**Industry analog:** Airflow and dbt batch pipelines

This case study examines **Design Data Pipeline / ETL** — a system type commonly built at Databricks and similar organizations. Design a scalable system for: **Data Pipeline / ETL**.
...
|----------|-------------|---------------------|
| Must | Core features for data pipeline / etl | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | data lake | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 10TB/day |
| 2 | Read vs write ratio? | batch+stream |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Data Pipeline / ETL.  
...
Design a scalable system for: **Data Pipeline / ETL**.
...
```
Sources → ETL/Spark → Data Lake → Warehouse → BI tools
```
...
**MVP success criteria for Design Data Pipeline / ETL:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Data Pipeline / ETL**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for data pipeline / etl. We're targeting 10TB/day with a batch+stream pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is data lake. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Airflow and dbt batch pipelines (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q55-data-pipeline-etl.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q55-data-pipeline-etl.md)
