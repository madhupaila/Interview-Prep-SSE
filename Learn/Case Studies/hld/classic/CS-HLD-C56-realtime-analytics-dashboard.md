# Design Real-Time Analytics Dashboard — Case Study

**Case Study ID:** CS-HLD-C56
**Track:** Classic HLD
**Companies:** Uber, LinkedIn
**Difficulty:** Medium
**Related question:** [Q56-realtime-analytics-dashboard.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q56-realtime-analytics-dashboard.md)

---

## Part 1 — Business Context

**Industry analog:** Grafana live metrics and Flink windows

This case study examines **Design Real-Time Analytics Dashboard** — a system type commonly built at Uber and similar organizations. Design a scalable system for: **Real-Time Analytics Dashboard**.
...
|----------|-------------|---------------------|
| Must | Core features for real-time analytics dashboard | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | WebSocket push | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1M events/sec |
| 2 | Read vs write ratio? | Flink aggregation |
...
| 7 | MVP scope? | Core WebSocket push |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Real-Time Analytics Dashboard.  
...
|--------|----------|
| Scale | 1M events/sec |
| Traffic pattern | Flink aggregation |
...
Design a scalable system for: **Real-Time Analytics Dashboard**.
...
```
Events → Collection API → Kafka → Stream Processor → Warehouse/Dashboard
```
...
**MVP success criteria for Design Real-Time Analytics Dashboard:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Real-Time Analytics Dashboard**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for real-time analytics dashboard. We're targeting 1M events/sec with a Flink aggregation pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is WebSocket push. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Grafana live metrics and Flink windows (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q56-realtime-analytics-dashboard.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q56-realtime-analytics-dashboard.md)
