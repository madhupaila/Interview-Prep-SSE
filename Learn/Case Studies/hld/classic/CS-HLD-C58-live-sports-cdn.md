# Design Content Delivery for Live Sports — Case Study

**Case Study ID:** CS-HLD-C58
**Track:** Classic HLD
**Companies:** ESPN, Amazon
**Difficulty:** Medium
**Related question:** [Q58-live-sports-cdn.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q58-live-sports-cdn.md)

---

## Part 1 — Business Context

**Industry analog:** ESPN low-latency live streaming

This case study examines **Design Content Delivery for Live Sports** — a system type commonly built at ESPN and similar organizations. Design a scalable system for: **Content Delivery for Live Sports**.
...
|----------|-------------|---------------------|
| Must | Core features for content delivery for live sports | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | multi-region origin | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 10M concurrent |
| 2 | Read vs write ratio? | low latency HLS |
...
| 7 | MVP scope? | Core multi-region origin |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Content Delivery for Live Sports.  
...
| Traffic pattern | low latency HLS |
...
Design a scalable system for: **Content Delivery for Live Sports**.
...
```
Upload → S3 → Transcode Workers → CDN → Client playback
Metadata → PostgreSQL
```
...
**MVP success criteria for Design Content Delivery for Live Sports:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Content Delivery for Live Sports**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for content delivery for live sports. We're targeting 10M concurrent with a low latency HLS pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is multi-region origin. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | ESPN low-latency live streaming (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q58-live-sports-cdn.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q58-live-sports-cdn.md)
