# Design Chatbot (Rule-Based, Pre-LLM) — Case Study

**Case Study ID:** CS-HLD-C59
**Track:** Classic HLD
**Companies:** Amazon, Microsoft
**Difficulty:** Hard
**Related question:** [Q59-rule-based-chatbot.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q59-rule-based-chatbot.md)

---

## Part 1 — Business Context

**Industry analog:** Dialogflow pre-LLM intent matching

This case study examines **Design Chatbot (Rule-Based, Pre-LLM)** — a system type commonly built at Amazon and similar organizations. Design a scalable system for: **Chatbot (Rule-Based, Pre-LLM)**.
...
|----------|-------------|---------------------|
| Must | Core features for chatbot (rule-based, pre-llm) | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | fallback to human | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | intent classification |
| 2 | Read vs write ratio? | dialog tree |
...
| 7 | MVP scope? | Core fallback to human |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Chatbot (Rule-Based, Pre-LLM).  
...
| Metric | Estimate |
|--------|----------|
| Scale | intent classification |
| Traffic pattern | dialog tree |
...
Design a scalable system for: **Chatbot (Rule-Based, Pre-LLM)**.
...
**MVP success criteria for Design Chatbot (Rule-Based, Pre-LLM):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Chatbot (Rule-Based, Pre-LLM)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for chatbot (rule-based, pre-llm). We're targeting intent classification with a dialog tree pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is fallback to human. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Dialogflow pre-LLM intent matching (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q59-rule-based-chatbot.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q59-rule-based-chatbot.md)
