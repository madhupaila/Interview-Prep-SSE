# Design Backup and Disaster Recovery — Case Study

**Case Study ID:** CS-HLD-C61
**Track:** Classic HLD
**Companies:** AWS, banks
**Difficulty:** Medium
**Related question:** [Q61-backup-disaster-recovery.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q61-backup-disaster-recovery.md)

---

## Part 1 — Business Context

**Industry analog:** AWS Backup cross-region RPO/RTO

This case study examines **Design Backup and Disaster Recovery** — a system type commonly built at AWS and similar organizations. Design a scalable system for: **Backup and Disaster Recovery**.
...
|----------|-------------|---------------------|
| Must | Core features for backup and disaster recovery | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | backup verification | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | RPO/RTO |
| 2 | Read vs write ratio? | multi-region |
...
| 7 | MVP scope? | Core backup verification |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Backup and Disaster Recovery.  
...
Design a scalable system for: **Backup and Disaster Recovery**.
...
**MVP success criteria for Design Backup and Disaster Recovery:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Backup and Disaster Recovery**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for backup and disaster recovery. We're targeting RPO/RTO with a multi-region pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is backup verification. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | AWS Backup cross-region RPO/RTO (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q61-backup-disaster-recovery.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q61-backup-disaster-recovery.md)
