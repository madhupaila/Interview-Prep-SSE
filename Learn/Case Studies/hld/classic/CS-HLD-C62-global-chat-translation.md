# Design Global Chat with Translation — Case Study

**Case Study ID:** CS-HLD-C62
**Track:** Classic HLD
**Companies:** WhatsApp, Telegram
**Difficulty:** Hard
**Related question:** [Q62-global-chat-translation.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q62-global-chat-translation.md)

---

## Part 1 — Business Context

**Industry analog:** WhatsApp real-time message translation

This case study examines **Design Global Chat with Translation** — a system type commonly built at WhatsApp and similar organizations. Design a scalable system for: **Global Chat with Translation**.
...
|----------|-------------|---------------------|
| Must | Core features for global chat with translation | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | message ordering | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 100 languages |
| 2 | Read vs write ratio? | real-time translate |
...
| 7 | MVP scope? | Core message ordering |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Global Chat with Translation.  
...
|--------|----------|
| Scale | 100 languages |
| Traffic pattern | real-time translate |
...
**MVP success criteria for Design Global Chat with Translation:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Global Chat with Translation**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for global chat with translation. We're targeting 100 languages with a real-time translate pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is message ordering. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | WhatsApp real-time message translation (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q62-global-chat-translation.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q62-global-chat-translation.md)
