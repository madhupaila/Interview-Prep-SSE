# Design Subscription Billing — Case Study

**Case Study ID:** CS-HLD-C64
**Track:** Classic HLD
**Companies:** Netflix, Spotify
**Difficulty:** Medium
**Related question:** [Q64-subscription-billing.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q64-subscription-billing.md)

---

## Part 1 — Business Context

**Industry analog:** Stripe Billing and dunning

This case study examines **Design Subscription Billing** — a system type commonly built at Netflix and similar organizations. Design a scalable system for: **Subscription Billing**.
...
|----------|-------------|---------------------|
| Must | Core features for subscription billing | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | proration | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | recurring |
| 2 | Read vs write ratio? | dunning |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Subscription Billing.  
...
Design a scalable system for: **Subscription Billing**.
...
```
Subscription Service → Billing Engine → Payment Provider → Invoice DB
```
...
**MVP success criteria for Design Subscription Billing:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Subscription Billing**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for subscription billing. We're targeting recurring with a dunning pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is proration. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Stripe Billing and dunning (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q64-subscription-billing.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q64-subscription-billing.md)
