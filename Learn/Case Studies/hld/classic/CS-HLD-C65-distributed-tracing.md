# Design Distributed Tracing System — Case Study

**Case Study ID:** CS-HLD-C65
**Track:** Classic HLD
**Companies:** Jaeger, Datadog
**Difficulty:** Medium
**Related question:** [Q65-distributed-tracing.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q65-distributed-tracing.md)

---

## Part 1 — Business Context

**Industry analog:** Jaeger and Datadog APM

This case study examines **Design Distributed Tracing System** — a system type commonly built at Jaeger and similar organizations. Design a scalable system for: **Distributed Tracing System**.
...
|----------|-------------|---------------------|
| Must | Core features for distributed tracing system | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | span storage | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1M traces/sec |
| 2 | Read vs write ratio? | sampling |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Distributed Tracing System.  
...
Design a scalable system for: **Distributed Tracing System**.
...
**MVP success criteria for Design Distributed Tracing System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Distributed Tracing System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Let me clarify requirements for distributed tracing system. We're targeting 1M traces/sec with a sampling pattern. I'll design the MVP core flow, estimate scale, draw the architecture, and we can deep-dive where you prefer."
...
> **Deep dive:** "The critical design decision here is span storage. [Explain pattern-specific logic — e.g., for feed: hybrid fan-out; for payments: idempotency keys and ledger.]"
...
| Capability | Jaeger and Datadog APM (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q65-distributed-tracing.md](../../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q65-distributed-tracing.md)
