# Design Code Assistant (Copilot-like) — Case Study

**Case Study ID:** CS-HLD-G03
**Track:** Gen AI / LLM HLD
**Companies:** GitHub, Cursor, Google
**Difficulty:** Hard
**Related question:** [Q03-code-assistant-copilot.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q03-code-assistant-copilot.md)
**Paired case study:** [CS-PAIR-11-code-assistant-copilot.md](../../paired/CS-PAIR-11-code-assistant-copilot.md)

---

## Part 1 — Business Context

**Industry analog:** GitHub Copilot and Cursor — inline code completion and chat

This case study examines **Design Code Assistant (Copilot-like)** — a system type commonly built at GitHub and similar organizations. Design a production system for: **Code Assistant (Copilot-like)**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for code assistant (copilot-like) | Verified in integration tests |
...
| Must | IDE integration, context from open files + repo | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 10M developers unless stated |
...
| 7 | Scale? | 10M developers, 200M completions/day |
| 8 | Offline/batch vs real-time? | Per focus: IDE integration, context from open files + repo |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Code Assistant (Copilot-like).  
...
| Metric | Estimate |
|--------|----------|
| Scale | 10M developers |
| Throughput | 200M completions/day |
...
**MVP success criteria for Design Code Assistant (Copilot-like):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Code Assistant (Copilot-like)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing code assistant (copilot-like) at scale — roughly 10M developers with 200M completions/day. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: IDE integration, context from open files + repo. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | GitHub Copilot and Cursor — inline code completion and chat (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q03-code-assistant-copilot.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q03-code-assistant-copilot.md)
- **End-to-end pair:** [CS-PAIR-11-code-assistant-copilot.md](../../paired/CS-PAIR-11-code-assistant-copilot.md)
