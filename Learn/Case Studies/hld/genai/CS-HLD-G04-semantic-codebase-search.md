# Design Semantic Search Over Codebase — Case Study

**Case Study ID:** CS-HLD-G04
**Track:** Gen AI / LLM HLD
**Companies:** Sourcegraph, Google
**Difficulty:** Hard
**Related question:** [Q04-semantic-codebase-search.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q04-semantic-codebase-search.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Semantic Search Over Codebase domain

This case study examines **Design Semantic Search Over Codebase** — a system type commonly built at Sourcegraph and similar organizations. Design a production system for: **Semantic Search Over Codebase**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for semantic search over codebase | Verified in integration tests |
...
| Must | AST-aware chunking, cross-repo search | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 50K repos unless stated |
...
| 7 | Scale? | 50K repos, 10M searches/day |
| 8 | Offline/batch vs real-time? | Per focus: AST-aware chunking, cross-repo search |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Semantic Search Over Codebase.  
...
**MVP success criteria for Design Semantic Search Over Codebase:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Semantic Search Over Codebase**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing semantic search over codebase at scale — roughly 50K repos with 10M searches/day. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: AST-aware chunking, cross-repo search. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Semantic Search Over Codebase domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q04-semantic-codebase-search.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q04-semantic-codebase-search.md)
