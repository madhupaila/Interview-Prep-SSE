# Design LLM API Gateway / Model Router — Case Study

**Case Study ID:** CS-HLD-G05
**Track:** Gen AI / LLM HLD
**Companies:** OpenAI, AWS, Anyscale
**Difficulty:** Hard
**Related question:** [Q05-llm-api-gateway.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q05-llm-api-gateway.md)
**Paired case study:** [CS-PAIR-10-llm-api-gateway.md](../../paired/CS-PAIR-10-llm-api-gateway.md)

---

## Part 1 — Business Context

**Industry analog:** OpenAI API and Azure OpenAI — model routing and quotas

This case study examines **Design LLM API Gateway / Model Router** — a system type commonly built at OpenAI and similar organizations. Design a production system for: **LLM API Gateway / Model Router**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for llm api gateway / model router | Verified in integration tests |
...
| Must | rate limiting, billing, fallback models | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 1M API consumers unless stated |
...
| 7 | Scale? | 1M API consumers, 1B tokens/day |
| 8 | Offline/batch vs real-time? | Per focus: rate limiting, billing, fallback models |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design LLM API Gateway / Model Router.  
...
**MVP success criteria for Design LLM API Gateway / Model Router:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design LLM API Gateway / Model Router**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing llm api gateway / model router at scale — roughly 1M API consumers with 1B tokens/day. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: rate limiting, billing, fallback models. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | OpenAI API and Azure OpenAI — model routing and quotas (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q05-llm-api-gateway.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q05-llm-api-gateway.md)
- **End-to-end pair:** [CS-PAIR-10-llm-api-gateway.md](../../paired/CS-PAIR-10-llm-api-gateway.md)
