# Design Multi-Agent Workflow Platform — Case Study

**Case Study ID:** CS-HLD-G08
**Track:** Gen AI / LLM HLD
**Companies:** LangChain, Microsoft
**Difficulty:** Hard
**Related question:** [Q08-multi-agent-workflow.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q08-multi-agent-workflow.md)
...
**Industry analog:** Microsoft AutoGen and CrewAI — multi-agent orchestration

This case study examines **Design Multi-Agent Workflow Platform** — a system type commonly built at LangChain and similar organizations. Design a production system for: **Multi-Agent Workflow Platform**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for multi-agent workflow platform | Verified in integration tests |
...
| Must | supervisor pattern, durable execution | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 1M workflows/day unless stated |
...
| 7 | Scale? | 1M workflows/day, tool registry |
| 8 | Offline/batch vs real-time? | Per focus: supervisor pattern, durable execution |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Multi-Agent Workflow Platform.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 1M workflows/day |
| Throughput | tool registry |
...
**MVP success criteria for Design Multi-Agent Workflow Platform:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Multi-Agent Workflow Platform**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing multi-agent workflow platform at scale — roughly 1M workflows/day with tool registry. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: supervisor pattern, durable execution. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Microsoft AutoGen and CrewAI — multi-agent orchestration (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q08-multi-agent-workflow.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q08-multi-agent-workflow.md)
