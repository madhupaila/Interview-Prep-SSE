# Design AI Customer Support Bot — Case Study

**Case Study ID:** CS-HLD-G09
**Track:** Gen AI / LLM HLD
**Companies:** Intercom, Zendesk, Amazon
**Difficulty:** Hard
**Related question:** [Q09-ai-customer-support-bot.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q09-ai-customer-support-bot.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design AI Customer Support Bot domain

This case study examines **Design AI Customer Support Bot** — a system type commonly built at Intercom and similar organizations. Design a production system for: **AI Customer Support Bot**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for ai customer support bot | Verified in integration tests |
...
| Must | CRM integration, sentiment escalation | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 5M tickets/month unless stated |
...
| 7 | Scale? | 5M tickets/month, human handoff |
| 8 | Offline/batch vs real-time? | Per focus: CRM integration, sentiment escalation |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design AI Customer Support Bot.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 5M tickets/month |
| Throughput | human handoff |
...
Design a production system for: **AI Customer Support Bot**.
...
**MVP success criteria for Design AI Customer Support Bot:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design AI Customer Support Bot**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing ai customer support bot at scale — roughly 5M tickets/month with human handoff. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: CRM integration, sentiment escalation. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design AI Customer Support Bot domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q09-ai-customer-support-bot.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q09-ai-customer-support-bot.md)
