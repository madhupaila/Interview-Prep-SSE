# Design Real-Time Meeting Summarizer — Case Study

**Case Study ID:** CS-HLD-G10
**Track:** Gen AI / LLM HLD
**Companies:** Zoom, Google
**Difficulty:** Hard
**Related question:** [Q10-meeting-summarizer.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q10-meeting-summarizer.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Real-Time Meeting Summarizer domain

This case study examines **Design Real-Time Meeting Summarizer** — a system type commonly built at Zoom and similar organizations. Design a production system for: **Real-Time Meeting Summarizer**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for real-time meeting summarizer | Verified in integration tests |
...
| Must | speaker diarization, action items | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 10M meetings/month unless stated |
...
| 7 | Scale? | 10M meetings/month, real-time transcription |
| 8 | Offline/batch vs real-time? | Per focus: speaker diarization, action items |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Real-Time Meeting Summarizer.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 10M meetings/month |
| Throughput | real-time transcription |
...
Design a production system for: **Real-Time Meeting Summarizer**.
...
**MVP success criteria for Design Real-Time Meeting Summarizer:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Real-Time Meeting Summarizer**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing real-time meeting summarizer at scale — roughly 10M meetings/month with real-time transcription. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: speaker diarization, action items. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Real-Time Meeting Summarizer domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q10-meeting-summarizer.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q10-meeting-summarizer.md)
