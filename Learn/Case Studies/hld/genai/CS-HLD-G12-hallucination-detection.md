# Design Hallucination Detection System — Case Study

**Case Study ID:** CS-HLD-G12
**Track:** Gen AI / LLM HLD
**Companies:** Anthropic, Google
**Difficulty:** Hard
**Related question:** [Q12-hallucination-detection.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q12-hallucination-detection.md)

---

## Part 1 — Business Context

**Industry analog:** RAGAS faithfulness metrics and NLI verification

This case study examines **Design Hallucination Detection System** — a system type commonly built at Anthropic and similar organizations. Design a production system for: **Hallucination Detection System**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for hallucination detection system | Verified in integration tests |
...
| Must | claim extraction, NLI verification | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 100M responses/day unless stated |
...
| 7 | Scale? | 100M responses/day, faithfulness scoring |
| 8 | Offline/batch vs real-time? | Per focus: claim extraction, NLI verification |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Hallucination Detection System.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 100M responses/day |
| Throughput | faithfulness scoring |
...
Design a production system for: **Hallucination Detection System**.
...
**MVP success criteria for Design Hallucination Detection System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Hallucination Detection System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing hallucination detection system at scale — roughly 100M responses/day with faithfulness scoring. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: claim extraction, NLI verification. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | RAGAS faithfulness metrics and NLI verification (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q12-hallucination-detection.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q12-hallucination-detection.md)
