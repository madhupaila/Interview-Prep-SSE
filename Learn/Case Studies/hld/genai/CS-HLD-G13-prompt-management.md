# Design Prompt Management + Versioning — Case Study

**Case Study ID:** CS-HLD-G13
**Track:** Gen AI / LLM HLD
**Companies:** LangSmith, Weights & Biases
**Difficulty:** Hard
**Related question:** [Q13-prompt-management.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q13-prompt-management.md)
**Paired case study:** [CS-PAIR-09-prompt-management.md](../../paired/CS-PAIR-09-prompt-management.md)

---

## Part 1 — Business Context

**Industry analog:** LangSmith and Humanloop — prompt versioning

This case study examines **Design Prompt Management + Versioning** — a system type commonly built at LangSmith and similar organizations. Design a production system for: **Prompt Management + Versioning**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for prompt management + versioning | Verified in integration tests |
...
| Must | rollback, environment promotion | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 10K prompts unless stated |
...
| 7 | Scale? | 10K prompts, A/B versions |
| 8 | Offline/batch vs real-time? | Per focus: rollback, environment promotion |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Prompt Management + Versioning.  
...
Design a production system for: **Prompt Management + Versioning**.
...
**MVP success criteria for Design Prompt Management + Versioning:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Prompt Management + Versioning**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing prompt management + versioning at scale — roughly 10K prompts with A/B versions. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: rollback, environment promotion. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | LangSmith and Humanloop — prompt versioning (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q13-prompt-management.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q13-prompt-management.md)
- **End-to-end pair:** [CS-PAIR-09-prompt-management.md](../../paired/CS-PAIR-09-prompt-management.md)
