# Design Content Moderation for LLM Apps — Case Study

**Case Study ID:** CS-HLD-G15
**Track:** Gen AI / LLM HLD
**Companies:** Meta, OpenAI
**Difficulty:** Hard
**Related question:** [Q15-content-moderation-llm.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q15-content-moderation-llm.md)
**Paired case study:** [CS-PAIR-16-content-moderation-llm.md](../../paired/CS-PAIR-16-content-moderation-llm.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Content Moderation for LLM Apps domain

This case study examines **Design Content Moderation for LLM Apps** — a system type commonly built at Meta and similar organizations. Design a production system for: **Content Moderation for LLM Apps**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for content moderation for llm apps | Verified in integration tests |
...
| Must | policy engine, appeal workflow | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 500M messages/day unless stated |
...
| 7 | Scale? | 500M messages/day, input+output filter |
| 8 | Offline/batch vs real-time? | Per focus: policy engine, appeal workflow |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Content Moderation for LLM Apps.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 500M messages/day |
| Throughput | input+output filter |
...
**MVP success criteria for Design Content Moderation for LLM Apps:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Content Moderation for LLM Apps**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing content moderation for llm apps at scale — roughly 500M messages/day with input+output filter. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: policy engine, appeal workflow. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Content Moderation for LLM Apps domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q15-content-moderation-llm.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q15-content-moderation-llm.md)
- **End-to-end pair:** [CS-PAIR-16-content-moderation-llm.md](../../paired/CS-PAIR-16-content-moderation-llm.md)
