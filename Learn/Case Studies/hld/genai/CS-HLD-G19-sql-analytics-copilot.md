# Design SQL-Generating Analytics Copilot — Case Study

**Case Study ID:** CS-HLD-G19
**Track:** Gen AI / LLM HLD
**Companies:** Databricks, Snowflake
**Difficulty:** Hard
**Related question:** [Q19-sql-analytics-copilot.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q19-sql-analytics-copilot.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design SQL-Generating Analytics Copilot domain

This case study examines **Design SQL-Generating Analytics Copilot** — a system type commonly built at Databricks and similar organizations. Design a production system for: **SQL-Generating Analytics Copilot**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for sql-generating analytics copilot | Verified in integration tests |
...
| Must | schema grounding, query validation | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 1M queries/day unless stated |
...
| 7 | Scale? | 1M queries/day, read-only DB access |
| 8 | Offline/batch vs real-time? | Per focus: schema grounding, query validation |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design SQL-Generating Analytics Copilot.  
...
| Throughput | read-only DB access |
...
Design a production system for: **SQL-Generating Analytics Copilot**.
...
**MVP success criteria for Design SQL-Generating Analytics Copilot:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design SQL-Generating Analytics Copilot**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing sql-generating analytics copilot at scale — roughly 1M queries/day with read-only DB access. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: schema grounding, query validation. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design SQL-Generating Analytics Copilot domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q19-sql-analytics-copilot.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q19-sql-analytics-copilot.md)
