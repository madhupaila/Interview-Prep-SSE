# Design Legal Contract Analysis System — Case Study

**Case Study ID:** CS-HLD-G20
**Track:** Gen AI / LLM HLD
**Companies:** Harvey, Ironclad
**Difficulty:** Hard
**Related question:** [Q20-legal-contract-analysis.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q20-legal-contract-analysis.md)

---

## Part 1 — Business Context

**Industry analog:** Harvey and Ironclad — contract clause extraction

This case study examines **Design Legal Contract Analysis System** — a system type commonly built at Harvey and similar organizations. Design a production system for: **Legal Contract Analysis System**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for legal contract analysis system | Verified in integration tests |
...
| Must | compliance, audit trail | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 1M contracts unless stated |
...
| 7 | Scale? | 1M contracts, clause extraction |
| 8 | Offline/batch vs real-time? | Per focus: compliance, audit trail |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Legal Contract Analysis System.  
...
**MVP success criteria for Design Legal Contract Analysis System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Legal Contract Analysis System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing legal contract analysis system at scale — roughly 1M contracts with clause extraction. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: compliance, audit trail. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Harvey and Ironclad — contract clause extraction (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q20-legal-contract-analysis.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q20-legal-contract-analysis.md)
