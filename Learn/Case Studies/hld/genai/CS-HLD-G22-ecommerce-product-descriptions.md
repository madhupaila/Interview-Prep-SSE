# Design E-Commerce Product Description Gen — Case Study

**Case Study ID:** CS-HLD-G22
**Track:** Gen AI / LLM HLD
**Companies:** Amazon, Shopify
**Difficulty:** Hard
**Related question:** [Q22-ecommerce-product-descriptions.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q22-ecommerce-product-descriptions.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design E-Commerce Product Description Gen domain

This case study examines **Design E-Commerce Product Description Gen** — a system type commonly built at Amazon and similar organizations. Design a production system for: **E-Commerce Product Description Gen**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for e-commerce product description gen | Verified in integration tests |
...
| Must | brand voice, SEO metadata | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 100M products unless stated |
...
| 7 | Scale? | 100M products, batch generation |
| 8 | Offline/batch vs real-time? | Per focus: brand voice, SEO metadata |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design E-Commerce Product Description Gen.  
...
Design a production system for: **E-Commerce Product Description Gen**.
...
```
User → API Gateway → Conversation Service → LLM Gateway → SSE Stream
              ↓              ↓
...
**MVP success criteria for Design E-Commerce Product Description Gen:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design E-Commerce Product Description Gen**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing e-commerce product description gen at scale — roughly 100M products with batch generation. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: brand voice, SEO metadata. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design E-Commerce Product Description Gen domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q22-ecommerce-product-descriptions.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q22-ecommerce-product-descriptions.md)
