# Design Personalized Learning Tutor — Case Study

**Case Study ID:** CS-HLD-G23
**Track:** Gen AI / LLM HLD
**Companies:** Khan Academy, Duolingo
**Difficulty:** Hard
**Related question:** [Q23-personalized-learning-tutor.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q23-personalized-learning-tutor.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Personalized Learning Tutor domain

This case study examines **Design Personalized Learning Tutor** — a system type commonly built at Khan Academy and similar organizations. Design a production system for: **Personalized Learning Tutor**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for personalized learning tutor | Verified in integration tests |
...
| Must | progress tracking, Socratic method | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 20M learners unless stated |
...
| 7 | Scale? | 20M learners, adaptive curriculum |
| 8 | Offline/batch vs real-time? | Per focus: progress tracking, Socratic method |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Personalized Learning Tutor.  
...
|--------|----------|
| Scale | 20M learners |
| Throughput | adaptive curriculum |
...
Design a production system for: **Personalized Learning Tutor**.
...
**MVP success criteria for Design Personalized Learning Tutor:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Personalized Learning Tutor**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing personalized learning tutor at scale — roughly 20M learners with adaptive curriculum. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: progress tracking, Socratic method. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Personalized Learning Tutor domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q23-personalized-learning-tutor.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q23-personalized-learning-tutor.md)
