# Design Fraud Detection with LLM Features — Case Study

**Case Study ID:** CS-HLD-G24
**Track:** Gen AI / LLM HLD
**Companies:** Stripe, PayPal
**Difficulty:** Hard
**Related question:** [Q24-fraud-detection-llm.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q24-fraud-detection-llm.md)

---

## Part 1 — Business Context

**Industry analog:** PayPal LLM feature extraction for fraud

This case study examines **Design Fraud Detection with LLM Features** — a system type commonly built at Stripe and similar organizations. Design a production system for: **Fraud Detection with LLM Features**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for fraud detection with llm features | Verified in integration tests |
...
| Must | explainable flags | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 1B transactions/day unless stated |
...
| 7 | Scale? | 1B transactions/day, rules + LLM narrative |
| 8 | Offline/batch vs real-time? | Per focus: explainable flags |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Fraud Detection with LLM Features.  
...
| Throughput | rules + LLM narrative |
...
Design a production system for: **Fraud Detection with LLM Features**.
...
**MVP success criteria for Design Fraud Detection with LLM Features:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Fraud Detection with LLM Features**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing fraud detection with llm features at scale — roughly 1B transactions/day with rules + LLM narrative. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: explainable flags. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | PayPal LLM feature extraction for fraud (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q24-fraud-detection-llm.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q24-fraud-detection-llm.md)
