# Design Log Analysis + Incident Copilot — Case Study

**Case Study ID:** CS-HLD-G25
**Track:** Gen AI / LLM HLD
**Companies:** Datadog, PagerDuty
**Difficulty:** Hard
**Related question:** [Q25-log-incident-copilot.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q25-log-incident-copilot.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Log Analysis + Incident Copilot domain

This case study examines **Design Log Analysis + Incident Copilot** — a system type commonly built at Datadog and similar organizations. Design a production system for: **Log Analysis + Incident Copilot**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for log analysis + incident copilot | Verified in integration tests |
...
| Must | runbook retrieval, alert correlation | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 10M logs/sec unless stated |
...
| 7 | Scale? | 10M logs/sec, on-call integration |
| 8 | Offline/batch vs real-time? | Per focus: runbook retrieval, alert correlation |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Log Analysis + Incident Copilot.  
...
|--------|----------|
| Scale | 10M logs/sec |
| Throughput | on-call integration |
...
Design a production system for: **Log Analysis + Incident Copilot**.
...
**MVP success criteria for Design Log Analysis + Incident Copilot:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Log Analysis + Incident Copilot**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing log analysis + incident copilot at scale — roughly 10M logs/sec with on-call integration. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: runbook retrieval, alert correlation. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Log Analysis + Incident Copilot domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q25-log-incident-copilot.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q25-log-incident-copilot.md)
