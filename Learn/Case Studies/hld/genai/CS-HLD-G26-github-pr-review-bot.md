# Design GitHub PR Review Bot — Case Study

**Case Study ID:** CS-HLD-G26
**Track:** Gen AI / LLM HLD
**Companies:** GitHub, GitLab
**Difficulty:** Hard
**Related question:** [Q26-github-pr-review-bot.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q26-github-pr-review-bot.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design GitHub PR Review Bot domain

This case study examines **Design GitHub PR Review Bot** — a system type commonly built at GitHub and similar organizations. Design a production system for: **GitHub PR Review Bot**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for github pr review bot | Verified in integration tests |
...
| Must | inline comments, security scan | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design GitHub PR Review Bot.  
...
**MVP success criteria for Design GitHub PR Review Bot:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design GitHub PR Review Bot**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Design GitHub PR Review Bot domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q26-github-pr-review-bot.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q26-github-pr-review-bot.md)
