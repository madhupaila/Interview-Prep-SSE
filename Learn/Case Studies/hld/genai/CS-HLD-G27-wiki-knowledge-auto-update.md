# Design Wiki/Knowledge Base Auto-Update — Case Study

**Case Study ID:** CS-HLD-G27
**Track:** Gen AI / LLM HLD
**Companies:** Confluence, Notion
**Difficulty:** Hard
**Related question:** [Q27-wiki-knowledge-auto-update.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q27-wiki-knowledge-auto-update.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Wiki/Knowledge Base Auto-Update domain

This case study examines **Design Wiki/Knowledge Base Auto-Update** — a system type commonly built at Confluence and similar organizations. Design a production system for: **Wiki/Knowledge Base Auto-Update**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for wiki/knowledge base auto-update | Verified in integration tests |
...
| Must | human approval before publish | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume CDC from sources unless stated |
...
| 7 | Scale? | CDC from sources, stale detection |
| 8 | Offline/batch vs real-time? | Per focus: human approval before publish |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Wiki/Knowledge Base Auto-Update.  
...
| Metric | Estimate |
|--------|----------|
| Scale | CDC from sources |
| Throughput | stale detection |
...
Design a production system for: **Wiki/Knowledge Base Auto-Update**.
...
**MVP success criteria for Design Wiki/Knowledge Base Auto-Update:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Wiki/Knowledge Base Auto-Update**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing wiki/knowledge base auto-update at scale — roughly CDC from sources with stale detection. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: human approval before publish. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Wiki/Knowledge Base Auto-Update domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q27-wiki-knowledge-auto-update.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q27-wiki-knowledge-auto-update.md)
