# Design Translation Service with LLM — Case Study

**Case Study ID:** CS-HLD-G28
**Track:** Gen AI / LLM HLD
**Companies:** Google, DeepL
**Difficulty:** Hard
**Related question:** [Q28-translation-service-llm.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q28-translation-service-llm.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Translation Service with LLM domain

This case study examines **Design Translation Service with LLM** — a system type commonly built at Google and similar organizations. Design a production system for: **Translation Service with LLM**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for translation service with llm | Verified in integration tests |
...
| Must | glossary, domain terms | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 1B words/day unless stated |
...
| 7 | Scale? | 1B words/day, 100+ languages |
| 8 | Offline/batch vs real-time? | Per focus: glossary, domain terms |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Translation Service with LLM.  
...
Design a production system for: **Translation Service with LLM**.
...
**MVP success criteria for Design Translation Service with LLM:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Translation Service with LLM**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing translation service with llm at scale — roughly 1B words/day with 100+ languages. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: glossary, domain terms. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Translation Service with LLM domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q28-translation-service-llm.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q28-translation-service-llm.md)
