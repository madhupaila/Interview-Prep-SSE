# Design Email Smart Compose — Case Study

**Case Study ID:** CS-HLD-G29
**Track:** Gen AI / LLM HLD
**Companies:** Google, Microsoft
**Difficulty:** Hard
**Related question:** [Q29-email-smart-compose.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q29-email-smart-compose.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Email Smart Compose domain

This case study examines **Design Email Smart Compose** — a system type commonly built at Google and similar organizations. Design a production system for: **Email Smart Compose**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for email smart compose | Verified in integration tests |
...
| Must | privacy, no training on user data | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 500M users unless stated |
...
| 7 | Scale? | 500M users, tone control |
| 8 | Offline/batch vs real-time? | Per focus: privacy, no training on user data |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Email Smart Compose.  
...
Design a production system for: **Email Smart Compose**.
...
**MVP success criteria for Design Email Smart Compose:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Email Smart Compose**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing email smart compose at scale — roughly 500M users with tone control. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: privacy, no training on user data. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Email Smart Compose domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q29-email-smart-compose.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q29-email-smart-compose.md)
