# Design Resume Screening System — Case Study

**Case Study ID:** CS-HLD-G30
**Track:** Gen AI / LLM HLD
**Companies:** LinkedIn, Greenhouse
**Difficulty:** Hard
**Related question:** [Q30-resume-screening.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q30-resume-screening.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Resume Screening System domain

This case study examines **Design Resume Screening System** — a system type commonly built at LinkedIn and similar organizations. Design a production system for: **Resume Screening System**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for resume screening system | Verified in integration tests |
...
| Must | structured scoring, explainability | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 10M resumes/month unless stated |
...
| 7 | Scale? | 10M resumes/month, bias mitigation |
| 8 | Offline/batch vs real-time? | Per focus: structured scoring, explainability |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Resume Screening System.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 10M resumes/month |
| Throughput | bias mitigation |
...
Design a production system for: **Resume Screening System**.
...
**MVP success criteria for Design Resume Screening System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Resume Screening System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing resume screening system at scale — roughly 10M resumes/month with bias mitigation. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: structured scoring, explainability. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Resume Screening System domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q30-resume-screening.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q30-resume-screening.md)
