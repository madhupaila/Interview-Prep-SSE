# Design Function-Calling Tool Platform — Case Study

**Case Study ID:** CS-HLD-G32
**Track:** Gen AI / LLM HLD
**Companies:** OpenAI, Anthropic
**Difficulty:** Hard
**Related question:** [Q32-function-calling-platform.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q32-function-calling-platform.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Function-Calling Tool Platform domain

This case study examines **Design Function-Calling Tool Platform** — a system type commonly built at OpenAI and similar organizations. Design a production system for: **Function-Calling Tool Platform**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for function-calling tool platform | Verified in integration tests |
...
| Must | auth scopes, sandbox | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 1M tool calls/day unless stated |
...
| 7 | Scale? | 1M tool calls/day, OpenAPI registry |
| 8 | Offline/batch vs real-time? | Per focus: auth scopes, sandbox |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Function-Calling Tool Platform.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 1M tool calls/day |
| Throughput | OpenAPI registry |
...
Design a production system for: **Function-Calling Tool Platform**.
...
**MVP success criteria for Design Function-Calling Tool Platform:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Function-Calling Tool Platform**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing function-calling tool platform at scale — roughly 1M tool calls/day with OpenAPI registry. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: auth scopes, sandbox. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Function-Calling Tool Platform domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q32-function-calling-platform.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q32-function-calling-platform.md)
