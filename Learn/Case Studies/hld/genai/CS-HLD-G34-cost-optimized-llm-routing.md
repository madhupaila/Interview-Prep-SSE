# Design Cost-Optimized LLM Routing — Case Study

**Case Study ID:** CS-HLD-G34
**Track:** Gen AI / LLM HLD
**Companies:** Anyscale, OpenRouter
**Difficulty:** Hard
**Related question:** [Q34-cost-optimized-llm-routing.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q34-cost-optimized-llm-routing.md)
**Paired case study:** [CS-PAIR-20-token-budget-cost.md](../../paired/CS-PAIR-20-token-budget-cost.md)

---

## Part 1 — Business Context

**Industry analog:** Martian and OpenRouter — model routing by cost/latency

This case study examines **Design Cost-Optimized LLM Routing** — a system type commonly built at Anyscale and similar organizations. Design a production system for: **Cost-Optimized LLM Routing**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for cost-optimized llm routing | Verified in integration tests |
...
| Must | cascade routing, semantic cache | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 10B tokens/day unless stated |
...
| 7 | Scale? | 10B tokens/day, 60% cost reduction |
| 8 | Offline/batch vs real-time? | Per focus: cascade routing, semantic cache |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Cost-Optimized LLM Routing.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 10B tokens/day |
| Throughput | 60% cost reduction |
...
Design a production system for: **Cost-Optimized LLM Routing**.
...
```
Client → LLM Gateway → Rate Limiter → Router → [Small Model | Large Model]
              ↓              ↓
         Semantic Cache    Billing/Metrics
```
...
**MVP success criteria for Design Cost-Optimized LLM Routing:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Cost-Optimized LLM Routing**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing cost-optimized llm routing at scale — roughly 10B tokens/day with 60% cost reduction. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: cascade routing, semantic cache. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Martian and OpenRouter — model routing by cost/latency (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q34-cost-optimized-llm-routing.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q34-cost-optimized-llm-routing.md)
- **End-to-end pair:** [CS-PAIR-20-token-budget-cost.md](../../paired/CS-PAIR-20-token-budget-cost.md)
...
- [Gen AI Framework](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/00-genai-hld-framework.md)
- [RAG Deep Dive](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/01-rag-pipeline-deep-dive.md)
- [Interview Framework](../../../System%20Design%20-%20High%20Level%20Design/00-interview-framework/01-hld-round-flow.md)
