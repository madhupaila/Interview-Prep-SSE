# Design Offline RAG for Air-Gapped Enterprise — Case Study

**Case Study ID:** CS-HLD-G35
**Track:** Gen AI / LLM HLD
**Companies:** Palantir, defense
**Difficulty:** Hard
**Related question:** [Q35-offline-airgapped-rag.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q35-offline-airgapped-rag.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Offline RAG for Air-Gapped Enterprise domain

This case study examines **Design Offline RAG for Air-Gapped Enterprise** — a system type commonly built at Palantir and similar organizations. Design a production system for: **Offline RAG for Air-Gapped Enterprise**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for offline rag for air-gapped enterprise | Verified in integration tests |
...
| Must | classified data handling | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume no internet unless stated |
...
| 7 | Scale? | no internet, on-prem GPUs |
| 8 | Offline/batch vs real-time? | Per focus: classified data handling |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Offline RAG for Air-Gapped Enterprise.  
...
**MVP success criteria for Design Offline RAG for Air-Gapped Enterprise:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Offline RAG for Air-Gapped Enterprise**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing offline rag for air-gapped enterprise at scale — roughly no internet with on-prem GPUs. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: classified data handling. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Offline RAG for Air-Gapped Enterprise domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q35-offline-airgapped-rag.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q35-offline-airgapped-rag.md)
