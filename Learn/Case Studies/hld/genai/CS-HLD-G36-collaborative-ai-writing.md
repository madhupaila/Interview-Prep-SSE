# Design Real-Time Collaborative AI Writing — Case Study

**Case Study ID:** CS-HLD-G36
**Track:** Gen AI / LLM HLD
**Companies:** Google Docs, Notion
**Difficulty:** Hard
**Related question:** [Q36-collaborative-ai-writing.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q36-collaborative-ai-writing.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Real-Time Collaborative AI Writing domain

This case study examines **Design Real-Time Collaborative AI Writing** — a system type commonly built at Google Docs and similar organizations. Design a production system for: **Real-Time Collaborative AI Writing**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for real-time collaborative ai writing | Verified in integration tests |
...
| Must | conflict resolution | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 10M concurrent unless stated |
...
| 7 | Scale? | 10M concurrent, OT + AI suggestions |
| 8 | Offline/batch vs real-time? | Per focus: conflict resolution |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Real-Time Collaborative AI Writing.  
...
Design a production system for: **Real-Time Collaborative AI Writing**.
...
**MVP success criteria for Design Real-Time Collaborative AI Writing:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Real-Time Collaborative AI Writing**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing real-time collaborative ai writing at scale — roughly 10M concurrent with OT + AI suggestions. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: conflict resolution. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Real-Time Collaborative AI Writing domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q36-collaborative-ai-writing.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q36-collaborative-ai-writing.md)
