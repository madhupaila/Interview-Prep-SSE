# Design A/B Testing for Prompts/Models — Case Study

**Case Study ID:** CS-HLD-G37
**Track:** Gen AI / LLM HLD
**Companies:** Netflix, Uber
**Difficulty:** Hard
**Related question:** [Q37-ab-testing-prompts-models.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q37-ab-testing-prompts-models.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design A/B Testing for Prompts/Models domain

This case study examines **Design A/B Testing for Prompts/Models** — a system type commonly built at Netflix and similar organizations. Design a production system for: **A/B Testing for Prompts/Models**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for a/b testing for prompts/models | Verified in integration tests |
...
| Must | feature flags integration | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 100 experiments/month unless stated |
...
| 7 | Scale? | 100 experiments/month, statistical significance |
| 8 | Offline/batch vs real-time? | Per focus: feature flags integration |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design A/B Testing for Prompts/Models.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 100 experiments/month |
| Throughput | statistical significance |
...
**MVP success criteria for Design A/B Testing for Prompts/Models:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design A/B Testing for Prompts/Models**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing a/b testing for prompts/models at scale — roughly 100 experiments/month with statistical significance. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: feature flags integration. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design A/B Testing for Prompts/Models domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q37-ab-testing-prompts-models.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q37-ab-testing-prompts-models.md)
