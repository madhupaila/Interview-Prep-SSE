# Design Synthetic Data Generation Pipeline — Case Study

**Case Study ID:** CS-HLD-G38
**Track:** Gen AI / LLM HLD
**Companies:** Scale AI, NVIDIA
**Difficulty:** Hard
**Related question:** [Q38-synthetic-data-generation.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q38-synthetic-data-generation.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Synthetic Data Generation Pipeline domain

This case study examines **Design Synthetic Data Generation Pipeline** — a system type commonly built at Scale AI and similar organizations. Design a production system for: **Synthetic Data Generation Pipeline**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for synthetic data generation pipeline | Verified in integration tests |
...
| Must | diversity, PII-free | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 1M synthetic samples/day unless stated |
...
| 7 | Scale? | 1M synthetic samples/day, quality filter |
| 8 | Offline/batch vs real-time? | Per focus: diversity, PII-free |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Synthetic Data Generation Pipeline.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 1M synthetic samples/day |
| Throughput | quality filter |
...
**MVP success criteria for Design Synthetic Data Generation Pipeline:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Synthetic Data Generation Pipeline**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing synthetic data generation pipeline at scale — roughly 1M synthetic samples/day with quality filter. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: diversity, PII-free. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Synthetic Data Generation Pipeline domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q38-synthetic-data-generation.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q38-synthetic-data-generation.md)
