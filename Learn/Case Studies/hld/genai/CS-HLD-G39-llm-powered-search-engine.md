# Design LLM-Powered Search Engine — Case Study

**Case Study ID:** CS-HLD-G39
**Track:** Gen AI / LLM HLD
**Companies:** Perplexity, Google
**Difficulty:** Hard
**Related question:** [Q39-llm-powered-search-engine.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q39-llm-powered-search-engine.md)

---

## Part 1 — Business Context

**Industry analog:** Google Search — crawl, index, rank, serve

This case study examines **Design LLM-Powered Search Engine** — a system type commonly built at Perplexity and similar organizations. Design a production system for: **LLM-Powered Search Engine**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for llm-powered search engine | Verified in integration tests |
...
| Must | web crawl + retrieval + synthesis | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 100M searches/day unless stated |
...
| 7 | Scale? | 100M searches/day, cited answers |
| 8 | Offline/batch vs real-time? | Per focus: web crawl + retrieval + synthesis |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design LLM-Powered Search Engine.  
...
| Metric | Estimate |
|--------|----------|
| Scale | 100M searches/day |
| Throughput | cited answers |
...
**MVP success criteria for Design LLM-Powered Search Engine:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design LLM-Powered Search Engine**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing llm-powered search engine at scale — roughly 100M searches/day with cited answers. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: web crawl + retrieval + synthesis. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Google Search — crawl, index, rank, serve (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q39-llm-powered-search-engine.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q39-llm-powered-search-engine.md)
