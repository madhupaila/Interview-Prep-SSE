# Design Agentic Browser Automation — Case Study

**Case Study ID:** CS-HLD-G40
**Track:** Gen AI / LLM HLD
**Companies:** Anthropic, startups
**Difficulty:** Hard
**Related question:** [Q40-agentic-browser-automation.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q40-agentic-browser-automation.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Design Agentic Browser Automation domain

This case study examines **Design Agentic Browser Automation** — a system type commonly built at Anthropic and similar organizations. Design a production system for: **Agentic Browser Automation**.
...
|----------|-------------|---------------------|
| Must | Core user-facing capability for agentic browser automation | Verified in integration tests |
...
| Must | human-in-loop for sensitive actions | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | B2B multi-tenant or consumer? | Assume 1M tasks/day unless stated |
...
| 7 | Scale? | 1M tasks/day, Playwright sandbox |
| 8 | Offline/batch vs real-time? | Per focus: human-in-loop for sensitive actions |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Agentic Browser Automation.  
...
Design a production system for: **Agentic Browser Automation**.
...
**MVP success criteria for Design Agentic Browser Automation:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Design Agentic Browser Automation**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.

> **Opening:** "Before I draw the architecture, I want to confirm scope. We're designing agentic browser automation at scale — roughly 1M tasks/day with Playwright sandbox. I'll focus on the core query path and ingestion if needed, and cover safety and cost."
...
> **Deep dive:** "Key decision: human-in-loop for sensitive actions. For hallucination mitigation, we require citations grounded in retrieved chunks and block answers when retrieval confidence is low. Prompt injection is handled by isolating system instructions from user and document content."
...
| Capability | Leading products in the Design Agentic Browser Automation domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q40-agentic-browser-automation.md](../../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q40-agentic-browser-automation.md)
