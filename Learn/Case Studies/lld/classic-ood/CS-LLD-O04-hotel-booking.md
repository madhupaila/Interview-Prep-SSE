...
**Case Study ID:** CS-LLD-O04
**Track:** Classic OOD
**Companies:** Airbnb, Amazon, Booking.com
**Difficulty:** Medium
**Related question:** [Q04-hotel-booking.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q04-hotel-booking.md)

---

## Part 1 — Business Context

**Industry analog:** Booking.com reservation engine

This case study examines **Hotel Booking System** — a system type commonly built at Airbnb and similar organizations. Design hotel room booking: search availability, reserve, cancel, check-in/out.
...
| Must | Search and filter matching resources | Verified in integration tests |
| Must | Create and cancel reservations with conflict checks | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Hotel Booking System.  
...
**MVP success criteria for Hotel Booking System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Hotel Booking System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Booking.com reservation engine (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q04-hotel-booking.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q04-hotel-booking.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/hotel-booking/) (full)
