...
**Case Study ID:** CS-LLD-O05
**Track:** Classic OOD
**Companies:** DoorDash, Uber, Swiggy
**Difficulty:** Medium
**Related question:** [Q05-restaurant-food-ordering.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q05-restaurant-food-ordering.md)

---

## Part 1 — Business Context

**Industry analog:** Toast POS kitchen display

This case study examines **Restaurant / Food Ordering** — a system type commonly built at DoorDash and similar organizations. Design in-restaurant ordering: menu, cart, kitchen queue, order status.
...
| Must | OrderService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Restaurant / Food Ordering.  
...
**MVP success criteria for Restaurant / Food Ordering:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Restaurant / Food Ordering**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Toast POS kitchen display (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q05-restaurant-food-ordering.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q05-restaurant-food-ordering.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/restaurant-food-ordering/) (full)
