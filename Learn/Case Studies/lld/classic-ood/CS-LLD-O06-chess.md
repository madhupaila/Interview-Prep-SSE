# Chess Game — Case Study

**Case Study ID:** CS-LLD-O06
**Track:** Classic OOD
**Companies:** Microsoft, Google, Meta
**Difficulty:** Hard
**Related question:** [Q06-chess.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q06-chess.md)
**Java implementation:** [chess](../../../System Design - Low Level Design/09-code-implementations/java/classic/chess/Demo.java)

---

## Part 1 — Business Context

**Industry analog:** Chess.com game engine and move validation

This case study examines **Chess Game** — a system type commonly built at Microsoft and similar organizations. Design a two-player chess game with move validation, check/checkmate, turn management.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Chess Game.  
...
**MVP success criteria for Chess Game:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Chess Game**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Chess.com game engine and move validation (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q06-chess.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q06-chess.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/chess/) (full)
