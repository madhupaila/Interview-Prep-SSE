...
**Case Study ID:** CS-LLD-O07
**Track:** Classic OOD
**Companies:** Amazon, Google
**Difficulty:** Easy
**Related question:** [Q07-tic-tac-toe.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q07-tic-tac-toe.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Tic-Tac-Toe domain

This case study examines **Tic-Tac-Toe** — a system type commonly built at Amazon and similar organizations. Design tic-tac-toe for two players with win/draw detection on NxN board.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Tic-Tac-Toe.  
...
**MVP success criteria for Tic-Tac-Toe:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Tic-Tac-Toe**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Tic-Tac-Toe domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q07-tic-tac-toe.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q07-tic-tac-toe.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/tic-tac-toe/) (full)
