...
**Case Study ID:** CS-LLD-O08
**Track:** Classic OOD
**Companies:** Amazon, Flipkart
**Difficulty:** Medium
**Related question:** [Q08-snake-and-ladder.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q08-snake-and-ladder.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Snake and Ladder domain

This case study examines **Snake and Ladder** — a system type commonly built at Amazon and similar organizations. Design snake-and-ladder board game with dice rolls, snakes, ladders, and win condition.
...
| Must | GameEngine handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Snake and Ladder.  
...
**MVP success criteria for Snake and Ladder:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Snake and Ladder**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Snake and Ladder domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q08-snake-and-ladder.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q08-snake-and-ladder.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/snake-and-ladder/) (full)
