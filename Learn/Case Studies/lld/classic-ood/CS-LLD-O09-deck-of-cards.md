...
**Case Study ID:** CS-LLD-O09
**Track:** Classic OOD
**Companies:** Amazon, Microsoft
**Difficulty:** Medium
**Related question:** [Q09-deck-of-cards.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q09-deck-of-cards.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Deck of Cards domain

This case study examines **Deck of Cards** — a system type commonly built at Amazon and similar organizations. Design a deck of cards supporting shuffle, deal, and card games (blackjack MVP).
...
| Must | DeckService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Deck of Cards.  
...
**MVP success criteria for Deck of Cards:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Deck of Cards**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Deck of Cards domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q09-deck-of-cards.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q09-deck-of-cards.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/deck-of-cards/) (full)
