...
**Case Study ID:** CS-LLD-O10
**Track:** Classic OOD
**Companies:** Amazon, Coca-Cola
**Difficulty:** Medium
**Related question:** [Q10-vending-machine.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q10-vending-machine.md)

---

## Part 1 — Business Context

**Industry analog:** Automated retail inventory and change

This case study examines **Vending Machine** — a system type commonly built at Amazon and similar organizations. Design vending machine: select item, insert coins, dispense, return change.
...
| Must | VendingMachine handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Vending Machine.  
...
**MVP success criteria for Vending Machine:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Vending Machine**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Automated retail inventory and change (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q10-vending-machine.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q10-vending-machine.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/vending-machine/) (full)
