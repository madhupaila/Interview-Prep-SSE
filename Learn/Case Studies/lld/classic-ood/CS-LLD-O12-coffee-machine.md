...
**Case Study ID:** CS-LLD-O12
**Track:** Classic OOD
**Companies:** Starbucks, Nestlé
**Difficulty:** Medium
**Related question:** [Q12-coffee-machine.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q12-coffee-machine.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Coffee Machine domain

This case study examines **Coffee Machine** — a system type commonly built at Starbucks and similar organizations. Design coffee machine with recipes, ingredients inventory, and brew states.
...
| Must | CoffeeMaker handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Coffee Machine.  
...
**MVP success criteria for Coffee Machine:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Coffee Machine**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Coffee Machine domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q12-coffee-machine.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q12-coffee-machine.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/coffee-machine/) (skeleton)
