# LRU Cache — Case Study

**Case Study ID:** CS-LLD-O13
**Track:** Classic OOD
**Companies:** Amazon, Google, Meta
**Difficulty:** Medium
**Related question:** [Q13-lru-cache.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q13-lru-cache.md)
...
**Industry analog:** Redis and Memcached — in-process cache vs distributed cache

This case study examines **LRU Cache** — a system type commonly built at Amazon and similar organizations. Design in-memory LRU cache with O(1) get/put and capacity eviction.
...
| Must | get(key) returns value and marks entry most recently used | Verified in integration tests |
| Must | put(key, value) inserts or updates; evicts LRU when at capacity | Verified in integration tests |
| Must | O(1) operations via HashMap + doubly linked list | Verified in integration tests |
| Must | Evict least recently used entry when size exceeds capacity | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for LRU Cache.  
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/lru-cache/) (full)
