# Logger / Log Aggregator — Case Study

**Case Study ID:** CS-LLD-O15
**Track:** Classic OOD
**Companies:** Splunk, Datadog, Amazon
**Difficulty:** Medium
**Related question:** [Q15-logger.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q15-logger.md)
**Java implementation:** [logger](../../../System Design - Low Level Design/09-code-implementations/java/classic/logger/Demo.java)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Logger / Log Aggregator domain

This case study examines **Logger / Log Aggregator** — a system type commonly built at Splunk and similar organizations. Design leveled logger with multiple appenders (console, file) and formatting.
...
| Must | Logger handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Logger / Log Aggregator.  
...
**MVP success criteria for Logger / Log Aggregator:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Logger / Log Aggregator**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Logger / Log Aggregator domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q15-logger.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q15-logger.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/logger/) (full)
