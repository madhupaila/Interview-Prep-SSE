# Task Scheduler — Case Study

**Case Study ID:** CS-LLD-O16
**Track:** Classic OOD
**Companies:** Amazon, Google, Microsoft
**Difficulty:** Medium
**Related question:** [Q16-task-scheduler.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q16-task-scheduler.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Task Scheduler domain

This case study examines **Task Scheduler** — a system type commonly built at Amazon and similar organizations. Design task scheduler executing jobs by priority or cron expression.
...
| Must | TaskScheduler handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Task Scheduler.  
...
**MVP success criteria for Task Scheduler:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Task Scheduler**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Task Scheduler domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q16-task-scheduler.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q16-task-scheduler.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/task-scheduler/) (full)
