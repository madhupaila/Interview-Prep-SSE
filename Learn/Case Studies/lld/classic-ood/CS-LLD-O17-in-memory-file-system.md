# In-Memory File System — Case Study

**Case Study ID:** CS-LLD-O17
**Track:** Classic OOD
**Companies:** Amazon, Google
**Difficulty:** Hard
**Related question:** [Q17-in-memory-file-system.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q17-in-memory-file-system.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the In-Memory File System domain

This case study examines **In-Memory File System** — a system type commonly built at Amazon and similar organizations. Design Unix-like in-memory FS: mkdir, ls, cd, touch, cat, find.
...
| Must | FileSystem handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for In-Memory File System.  
...
**MVP success criteria for In-Memory File System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **In-Memory File System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the In-Memory File System domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q17-in-memory-file-system.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q17-in-memory-file-system.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/in-memory-file-system/) (full)
