# Splitwise Expense Sharing — Case Study

**Case Study ID:** CS-LLD-O18
**Track:** Classic OOD
**Companies:** Splitwise, Amazon
**Difficulty:** Medium
**Related question:** [Q18-splitwise.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q18-splitwise.md)
**Java implementation:** [splitwise](../../../System Design - Low Level Design/09-code-implementations/java/classic/splitwise/Demo.java)

---

## Part 1 — Business Context

**Industry analog:** Splitwise balance simplification graph

This case study examines **Splitwise Expense Sharing** — a system type commonly built at Splitwise and similar organizations. Design expense sharing: add bill, split equally/percent, settle balances.
...
| Must | Split expenses and track balances | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Splitwise Expense Sharing.  
...
**MVP success criteria for Splitwise Expense Sharing:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Splitwise Expense Sharing**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Splitwise balance simplification graph (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q18-splitwise.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q18-splitwise.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/splitwise/) (full)
