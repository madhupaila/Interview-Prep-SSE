# Movie Ticket Booking — Case Study

**Case Study ID:** CS-LLD-O19
**Track:** Classic OOD
**Companies:** BookMyShow, Amazon
**Difficulty:** Medium
**Related question:** [Q19-movie-ticket-booking.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q19-movie-ticket-booking.md)

---

## Part 1 — Business Context

**Industry analog:** BookMyShow seat lock and payment

This case study examines **Movie Ticket Booking** — a system type commonly built at BookMyShow and similar organizations. Design cinema booking: shows, seats, lock seats, payment, confirm.
...
| Must | BookingService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Movie Ticket Booking.  
...
**MVP success criteria for Movie Ticket Booking:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Movie Ticket Booking**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | BookMyShow seat lock and payment (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q19-movie-ticket-booking.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q19-movie-ticket-booking.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/movie-ticket-booking/) (full)
