...
**Case Study ID:** CS-LLD-O20
**Track:** Classic OOD
**Companies:** Hertz, Amazon, Enterprise
**Difficulty:** Medium
**Related question:** [Q20-car-rental.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q20-car-rental.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Car Rental System domain

This case study examines **Car Rental System** — a system type commonly built at Hertz and similar organizations. Design car rental: fleet, reservations, pickup/return, pricing.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Car Rental System.  
...
**MVP success criteria for Car Rental System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Car Rental System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Car Rental System domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q20-car-rental.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q20-car-rental.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/car-rental/) (full)
