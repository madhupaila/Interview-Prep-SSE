# Ride Sharing (Uber) — Case Study

**Case Study ID:** CS-LLD-O21
**Track:** Classic OOD
**Companies:** Uber, Lyft, Amazon
**Difficulty:** Hard
**Related question:** [Q21-ride-sharing-uber.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q21-ride-sharing-uber.md)
...
**Industry analog:** Uber trip state machine and matching

This case study examines **Ride Sharing (Uber)** — a system type commonly built at Uber and similar organizations. Design ride matching: request ride, match driver, trip lifecycle, fare.
...
| Must | RideService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Ride Sharing (Uber).  
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/ride-sharing-uber/) (full)
