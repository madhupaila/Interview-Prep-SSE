...
**Case Study ID:** CS-LLD-O22
**Track:** Classic OOD
**Companies:** Amazon, Walmart, Shopify
**Difficulty:** Medium
**Related question:** [Q22-shopping-cart.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q22-shopping-cart.md)
...
This case study examines **Shopping Cart** — a system type commonly built at Amazon and similar organizations. Design e-commerce cart: add/remove items, quantity, apply coupon, checkout.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Shopping Cart.  
...
**MVP success criteria for Shopping Cart:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Shopping Cart**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
- **Question file:** [Q22-shopping-cart.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q22-shopping-cart.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/shopping-cart/) (full)
