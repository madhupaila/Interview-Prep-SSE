...
**Case Study ID:** CS-LLD-O23
**Track:** Classic OOD
**Companies:** Amazon, Walmart
**Difficulty:** Medium
**Related question:** [Q23-inventory-management.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q23-inventory-management.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Inventory Management domain

This case study examines **Inventory Management** — a system type commonly built at Amazon and similar organizations. Design warehouse inventory: SKUs, stock levels, reserve, reorder alerts.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Inventory Management.  
...
**MVP success criteria for Inventory Management:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Inventory Management**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Inventory Management domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q23-inventory-management.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q23-inventory-management.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/inventory-management/) (full)
