# Messenger (1:1 Chat) — Case Study

**Case Study ID:** CS-LLD-O24
**Track:** Classic OOD
**Companies:** Meta, WhatsApp, Slack
**Difficulty:** Medium
**Related question:** [Q24-messenger-1to1.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q24-messenger-1to1.md)
...
**Industry analog:** WhatsApp message delivery states

This case study examines **Messenger (1:1 Chat)** — a system type commonly built at Meta and similar organizations. Design 1:1 messaging: send, deliver, read receipts, conversation threads.
...
| Must | Send messages with delivery status tracking | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Messenger (1:1 Chat).  
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/messenger-1to1/) (full)
