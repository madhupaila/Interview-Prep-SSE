...
**Case Study ID:** CS-LLD-O25
**Track:** Classic OOD
**Companies:** Amazon, Twilio, Slack
**Difficulty:** Medium
**Related question:** [Q25-notification-system.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q25-notification-system.md)
...
This case study examines **Notification System** — a system type commonly built at Amazon and similar organizations. Design multi-channel notifications: email, SMS, push with templates.
...
| Must | NotificationService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Notification System.  
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/notification-system/) (full)
