# Meeting Scheduler — Case Study

**Case Study ID:** CS-LLD-O26
**Track:** Classic OOD
**Companies:** Google, Microsoft, Zoom
**Difficulty:** Medium
**Related question:** [Q26-meeting-scheduler.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q26-meeting-scheduler.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Meeting Scheduler domain

This case study examines **Meeting Scheduler** — a system type commonly built at Google and similar organizations. Design meeting scheduler: propose slots, check conflicts, book room.
...
| Must | SchedulerService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Meeting Scheduler.  
...
**MVP success criteria for Meeting Scheduler:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Meeting Scheduler**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Meeting Scheduler domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q26-meeting-scheduler.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q26-meeting-scheduler.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/meeting-scheduler/) (full)
