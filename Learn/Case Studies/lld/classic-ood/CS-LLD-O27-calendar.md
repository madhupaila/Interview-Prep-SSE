# Calendar Application — Case Study

**Case Study ID:** CS-LLD-O27
**Track:** Classic OOD
**Companies:** Apple, Google, Microsoft
**Difficulty:** Medium
**Related question:** [Q27-calendar.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q27-calendar.md)
**Java implementation:** [calendar](../../../System Design - Low Level Design/09-code-implementations/java/classic/calendar/README.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Calendar Application domain

This case study examines **Calendar Application** — a system type commonly built at Apple and similar organizations. Design personal calendar: events, recurring rules, reminders, views.
...
| Must | CalendarService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Calendar Application.  
...
**MVP success criteria for Calendar Application:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Calendar Application**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Calendar Application domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q27-calendar.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q27-calendar.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/calendar/) (full)
