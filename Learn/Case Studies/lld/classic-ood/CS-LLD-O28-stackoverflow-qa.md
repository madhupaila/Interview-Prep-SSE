# Stack Overflow Q&A — Case Study

**Case Study ID:** CS-LLD-O28
**Track:** Classic OOD
**Companies:** Stack Overflow, Google
**Difficulty:** Medium
**Related question:** [Q28-stackoverflow-qa.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q28-stackoverflow-qa.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Stack Overflow Q&A domain

This case study examines **Stack Overflow Q&A** — a system type commonly built at Stack Overflow and similar organizations. Design Q&A platform object model: questions, answers, votes, tags, reputation.
...
| Must | QAService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Stack Overflow Q&A.  
...
**MVP success criteria for Stack Overflow Q&A:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Stack Overflow Q&A**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Stack Overflow Q&A domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q28-stackoverflow-qa.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q28-stackoverflow-qa.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/stackoverflow-qa/) (skeleton)
