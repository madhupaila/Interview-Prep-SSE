# Pub/Sub Event Bus — Case Study

**Case Study ID:** CS-LLD-O29
**Track:** Classic OOD
**Companies:** Amazon, Google, Kafka
**Difficulty:** Medium
**Related question:** [Q29-pubsub-event-bus.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q29-pubsub-event-bus.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Pub/Sub Event Bus domain

This case study examines **Pub/Sub Event Bus** — a system type commonly built at Amazon and similar organizations. Design in-process pub/sub: topics, subscribers, async delivery.
...
| Must | EventBus handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Pub/Sub Event Bus.  
...
**MVP success criteria for Pub/Sub Event Bus:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Pub/Sub Event Bus**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Pub/Sub Event Bus domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q29-pubsub-event-bus.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q29-pubsub-event-bus.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/pubsub-event-bus/) (full)
