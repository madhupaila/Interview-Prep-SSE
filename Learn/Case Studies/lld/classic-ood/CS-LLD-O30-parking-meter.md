# Parking Meter — Case Study

**Case Study ID:** CS-LLD-O30
**Track:** Classic OOD
**Companies:** City apps, Amazon
**Difficulty:** Easy
**Related question:** [Q30-parking-meter.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q30-parking-meter.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Parking Meter domain

This case study examines **Parking Meter** — a system type commonly built at City apps and similar organizations. Design parking meter: pay for duration, expire, fine extension.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Parking Meter.  
...
**MVP success criteria for Parking Meter:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Parking Meter**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Parking Meter domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q30-parking-meter.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q30-parking-meter.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/parking-meter/) (skeleton)
