# Hotel Key Card System — Case Study

**Case Study ID:** CS-LLD-O31
**Track:** Classic OOD
**Companies:** Marriott, Hilton
**Difficulty:** Medium
**Related question:** [Q31-hotel-key-card.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q31-hotel-key-card.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Hotel Key Card System domain

This case study examines **Hotel Key Card System** — a system type commonly built at Marriott and similar organizations. Design hotel key card: encode room access, expiry, revoke on checkout.
...
| Must | Checkout and return items with business rules | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Hotel Key Card System.  
...
**MVP success criteria for Hotel Key Card System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Hotel Key Card System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Hotel Key Card System domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q31-hotel-key-card.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q31-hotel-key-card.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/hotel-key-card/) (skeleton)
