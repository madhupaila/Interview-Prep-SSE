# Warehouse Locker Service — Case Study

**Case Study ID:** CS-LLD-O32
**Track:** Classic OOD
**Companies:** Amazon, UPS
**Difficulty:** Medium
**Related question:** [Q32-warehouse-locker.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q32-warehouse-locker.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Warehouse Locker Service domain

This case study examines **Warehouse Locker Service** — a system type commonly built at Amazon and similar organizations. Design parcel lockers: allocate compartment, deposit, pickup code.
...
| Must | LockerService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Warehouse Locker Service.  
...
**MVP success criteria for Warehouse Locker Service:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Warehouse Locker Service**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Warehouse Locker Service domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q32-warehouse-locker.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q32-warehouse-locker.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/warehouse-locker/) (full)
