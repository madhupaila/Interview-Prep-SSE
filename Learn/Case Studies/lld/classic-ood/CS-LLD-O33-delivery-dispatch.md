# Delivery Dispatch — Case Study

**Case Study ID:** CS-LLD-O33
**Track:** Classic OOD
**Companies:** DoorDash, Amazon, FedEx
**Difficulty:** Medium
**Related question:** [Q33-delivery-dispatch.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q33-delivery-dispatch.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Delivery Dispatch domain

This case study examines **Delivery Dispatch** — a system type commonly built at DoorDash and similar organizations. Design last-mile dispatch: assign orders to drivers by proximity.
...
| Must | DispatchService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Delivery Dispatch.  
...
**MVP success criteria for Delivery Dispatch:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Delivery Dispatch**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Delivery Dispatch domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q33-delivery-dispatch.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q33-delivery-dispatch.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/delivery-dispatch/) (full)
