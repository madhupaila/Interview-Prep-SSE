...
**Case Study ID:** CS-LLD-O34
**Track:** Classic OOD
**Companies:** Coursera, Amazon
**Difficulty:** Medium
**Related question:** [Q34-course-registration.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q34-course-registration.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Course Registration domain

This case study examines **Course Registration** — a system type commonly built at Coursera and similar organizations. Design university registration: courses, seats, waitlist, prerequisites.
...
| Must | RegistrationService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Course Registration.  
...
**MVP success criteria for Course Registration:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Course Registration**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Course Registration domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q34-course-registration.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q34-course-registration.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/course-registration/) (full)
