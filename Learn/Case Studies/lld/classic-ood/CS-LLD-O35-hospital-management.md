...
**Case Study ID:** CS-LLD-O35
**Track:** Classic OOD
**Companies:** Epic, Cerner, Amazon
**Difficulty:** Hard
**Related question:** [Q35-hospital-management.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q35-hospital-management.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Hospital Management domain

This case study examines **Hospital Management** — a system type commonly built at Epic and similar organizations. Design hospital system: patients, doctors, appointments, medical records.
...
| Must | HospitalService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Hospital Management.  
...
**MVP success criteria for Hospital Management:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Hospital Management**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Hospital Management domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q35-hospital-management.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q35-hospital-management.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/hospital-management/) (skeleton)
