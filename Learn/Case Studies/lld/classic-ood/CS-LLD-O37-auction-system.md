...
**Case Study ID:** CS-LLD-O37
**Track:** Classic OOD
**Companies:** eBay, Amazon
**Difficulty:** Medium
**Related question:** [Q37-auction-system.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q37-auction-system.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Auction System domain

This case study examines **Auction System** — a system type commonly built at eBay and similar organizations. Design auction: place bid, anti-sniping, highest bidder wins.
...
| Must | Place bids with validation and winner selection | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Auction System.  
...
**MVP success criteria for Auction System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Auction System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Auction System domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q37-auction-system.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q37-auction-system.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/auction-system/) (full)
