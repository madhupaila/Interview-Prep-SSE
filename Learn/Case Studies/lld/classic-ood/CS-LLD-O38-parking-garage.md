# Parking Garage Multi-Entry — Case Study

**Case Study ID:** CS-LLD-O38
**Track:** Classic OOD
**Companies:** Amazon, Simon
**Difficulty:** Hard
**Related question:** [Q38-parking-garage.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q38-parking-garage.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Parking Garage Multi-Entry domain

This case study examines **Parking Garage Multi-Entry** — a system type commonly built at Amazon and similar organizations. Design multi-entry garage with per-entrance displays and central occupancy.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Parking Garage Multi-Entry.  
...
**MVP success criteria for Parking Garage Multi-Entry:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Parking Garage Multi-Entry**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Parking Garage Multi-Entry domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q38-parking-garage.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q38-parking-garage.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/parking-garage/) (skeleton)
