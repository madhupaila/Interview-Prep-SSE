# Traffic Light System — Case Study

**Case Study ID:** CS-LLD-O39
**Track:** Classic OOD
**Companies:** City systems, Siemens
**Difficulty:** Medium
**Related question:** [Q39-traffic-light.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q39-traffic-light.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Traffic Light System domain

This case study examines **Traffic Light System** — a system type commonly built at City systems and similar organizations. Design intersection traffic lights with timed phases and pedestrian crossing.
...
| Must | TrafficController handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Traffic Light System.  
...
**MVP success criteria for Traffic Light System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Traffic Light System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Traffic Light System domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q39-traffic-light.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q39-traffic-light.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/traffic-light/) (skeleton)
