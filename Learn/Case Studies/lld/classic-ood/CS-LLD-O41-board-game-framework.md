# Board Game Framework — Case Study

**Case Study ID:** CS-LLD-O41
**Track:** Classic OOD
**Companies:** EA, Hasbro
**Difficulty:** Medium
**Related question:** [Q41-board-game-framework.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q41-board-game-framework.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Board Game Framework domain

This case study examines **Board Game Framework** — a system type commonly built at EA and similar organizations. Design extensible board game framework: board, players, turns, rules engine.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Board Game Framework.  
...
**MVP success criteria for Board Game Framework:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Board Game Framework**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Board Game Framework domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q41-board-game-framework.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q41-board-game-framework.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/board-game-framework/) (full)
