# Playlist Manager — Case Study

**Case Study ID:** CS-LLD-O42
**Track:** Classic OOD
**Companies:** Apple Music, Spotify
**Difficulty:** Medium
**Related question:** [Q42-playlist-manager.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q42-playlist-manager.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Playlist Manager domain

This case study examines **Playlist Manager** — a system type commonly built at Apple Music and similar organizations. Design playlist CRUD, shuffle, repeat, collaborative editing.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Playlist Manager.  
...
**MVP success criteria for Playlist Manager:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Playlist Manager**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Playlist Manager domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q42-playlist-manager.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q42-playlist-manager.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/playlist-manager/) (full)
