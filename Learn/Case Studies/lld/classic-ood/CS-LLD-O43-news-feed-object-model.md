# News Feed Object Model — Case Study

**Case Study ID:** CS-LLD-O43
**Track:** Classic OOD
**Companies:** Meta, Twitter, LinkedIn
**Difficulty:** Medium
**Related question:** [Q43-news-feed-object-model.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q43-news-feed-object-model.md)
...
**Industry analog:** Facebook News Feed object graph

This case study examines **News Feed Object Model** — a system type commonly built at Meta and similar organizations. Design feed object model: posts, reactions, ranking stub, pagination.
...
| Must | FeedService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for News Feed Object Model.  
...
**MVP success criteria for News Feed Object Model:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **News Feed Object Model**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Facebook News Feed object graph (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q43-news-feed-object-model.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q43-news-feed-object-model.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/news-feed-object-model/) (skeleton)
