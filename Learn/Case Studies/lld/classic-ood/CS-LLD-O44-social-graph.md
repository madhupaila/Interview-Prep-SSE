# Social Graph — Case Study

**Case Study ID:** CS-LLD-O44
**Track:** Classic OOD
**Companies:** Meta, LinkedIn
**Difficulty:** Medium
**Related question:** [Q44-social-graph.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q44-social-graph.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Social Graph domain

This case study examines **Social Graph** — a system type commonly built at Meta and similar organizations. Design social graph: follow/friend edges, suggestions, BFS reach.
...
| Must | GraphService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Social Graph.  
...
**MVP success criteria for Social Graph:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Social Graph**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Social Graph domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q44-social-graph.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q44-social-graph.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/social-graph/) (skeleton)
