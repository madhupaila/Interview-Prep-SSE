# Friend Request Flow — Case Study

**Case Study ID:** CS-LLD-O45
**Track:** Classic OOD
**Companies:** Meta, LinkedIn
**Difficulty:** Medium
**Related question:** [Q45-friend-request.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q45-friend-request.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Friend Request Flow domain

This case study examines **Friend Request Flow** — a system type commonly built at Meta and similar organizations. Design friend requests: send, accept, reject, block, pending state.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Friend Request Flow.  
...
**MVP success criteria for Friend Request Flow:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Friend Request Flow**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Friend Request Flow domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q45-friend-request.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q45-friend-request.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/friend-request/) (skeleton)
