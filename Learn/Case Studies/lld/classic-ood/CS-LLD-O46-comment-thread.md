# Comment Thread — Case Study

**Case Study ID:** CS-LLD-O46
**Track:** Classic OOD
**Companies:** Reddit, YouTube
**Difficulty:** Medium
**Related question:** [Q46-comment-thread.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q46-comment-thread.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Comment Thread domain

This case study examines **Comment Thread** — a system type commonly built at Reddit and similar organizations. Design nested comments: post, reply, edit, delete, sort top/new.
...
| Must | CommentService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Comment Thread.  
...
**MVP success criteria for Comment Thread:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Comment Thread**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Comment Thread domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q46-comment-thread.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q46-comment-thread.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/comment-thread/) (skeleton)
