# Bookmark Manager — Case Study

**Case Study ID:** CS-LLD-O47
**Track:** Classic OOD
**Companies:** Browser, Pinterest
**Difficulty:** Easy
**Related question:** [Q47-bookmark-manager.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q47-bookmark-manager.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Bookmark Manager domain

This case study examines **Bookmark Manager** — a system type commonly built at Browser and similar organizations. Design bookmarks: folders, tags, URL validation, search.
...
| Must | Add bookmark with URL validation and folder placement | Verified in integration tests |
| Must | Organize bookmarks in nested folder tree (Composite) | Verified in integration tests |
| Must | Tag bookmarks for multi-label classification | Verified in integration tests |
| Must | Search bookmarks by title, URL, or tag | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Bookmark Manager.  
...
**MVP success criteria for Bookmark Manager:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Bookmark Manager**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Bookmark Manager domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q47-bookmark-manager.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q47-bookmark-manager.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/bookmark-manager/) (skeleton)
