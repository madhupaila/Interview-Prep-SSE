...
**Case Study ID:** CS-LLD-O48
**Track:** Classic OOD
**Companies:** Amazon, Etsy
**Difficulty:** Easy
**Related question:** [Q48-wishlist.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q48-wishlist.md)
**Java implementation:** [wishlist](../../../System Design - Low Level Design/09-code-implementations/java/classic/wishlist/README.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Wishlist domain

This case study examines **Wishlist** — a system type commonly built at Amazon and similar organizations. Design product wishlist: add, remove, share, price drop notify.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Wishlist.  
...
**MVP success criteria for Wishlist:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Wishlist**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Wishlist domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q48-wishlist.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q48-wishlist.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/wishlist/) (skeleton)
