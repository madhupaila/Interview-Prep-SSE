# Coupon Engine — Case Study

**Case Study ID:** CS-LLD-O49
**Track:** Classic OOD
**Companies:** Amazon, Shopify
**Difficulty:** Medium
**Related question:** [Q49-coupon-engine.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q49-coupon-engine.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Coupon Engine domain

This case study examines **Coupon Engine** — a system type commonly built at Amazon and similar organizations. Design coupon engine: percent/fixed off, min cart, expiry, stack rules.
...
| Must | CouponService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Coupon Engine.  
...
**MVP success criteria for Coupon Engine:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Coupon Engine**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Coupon Engine domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q49-coupon-engine.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q49-coupon-engine.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/coupon-engine/) (full)
