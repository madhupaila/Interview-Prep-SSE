# Loyalty Points — Case Study

**Case Study ID:** CS-LLD-O50
**Track:** Classic OOD
**Companies:** Airlines, Starbucks
**Difficulty:** Medium
**Related question:** [Q50-loyalty-points.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q50-loyalty-points.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Loyalty Points domain

This case study examines **Loyalty Points** — a system type commonly built at Airlines and similar organizations. Design loyalty program: earn on purchase, redeem, tier levels.
...
| Must | LoyaltyService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Loyalty Points.  
...
**MVP success criteria for Loyalty Points:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Loyalty Points**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Loyalty Points domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q50-loyalty-points.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q50-loyalty-points.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/loyalty-points/) (skeleton)
