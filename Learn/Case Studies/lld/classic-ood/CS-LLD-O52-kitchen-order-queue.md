# Kitchen Order Queue — Case Study

**Case Study ID:** CS-LLD-O52
**Track:** Classic OOD
**Companies:** Restaurant POS
**Difficulty:** Medium
**Related question:** [Q52-kitchen-order-queue.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q52-kitchen-order-queue.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Kitchen Order Queue domain

This case study examines **Kitchen Order Queue** — a system type commonly built at Restaurant POS and similar organizations. Design kitchen display queue: order priority, prep stations, bump bar.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Kitchen Order Queue.  
...
**MVP success criteria for Kitchen Order Queue:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Kitchen Order Queue**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Kitchen Order Queue domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q52-kitchen-order-queue.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q52-kitchen-order-queue.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/kitchen-order-queue/) (skeleton)
