# Drive-Thru System — Case Study

**Case Study ID:** CS-LLD-O53
**Track:** Classic OOD
**Companies:** Chick-fil-A, McDonald's
**Difficulty:** Medium
**Related question:** [Q53-drive-thru.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q53-drive-thru.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Drive-Thru System domain

This case study examines **Drive-Thru System** — a system type commonly built at Chick-fil-A and similar organizations. Design drive-thru lane: order post, payment, pickup window sequencing.
...
| Must | DriveThruService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Drive-Thru System.  
...
**MVP success criteria for Drive-Thru System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Drive-Thru System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Drive-Thru System domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q53-drive-thru.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q53-drive-thru.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/drive-thru/) (skeleton)
