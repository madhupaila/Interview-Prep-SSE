# Bus Transit System — Case Study

**Case Study ID:** CS-LLD-O54
**Track:** Classic OOD
**Companies:** City transit
**Difficulty:** Medium
**Related question:** [Q54-bus-transit.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q54-bus-transit.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Bus Transit System domain

This case study examines **Bus Transit System** — a system type commonly built at City transit and similar organizations. Design bus routes, stops, schedules, real-time ETA stub.
...
| Must | TransitService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Bus Transit System.  
...
**MVP success criteria for Bus Transit System:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Bus Transit System**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Bus Transit System domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q54-bus-transit.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q54-bus-transit.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/bus-transit/) (skeleton)
