# Flight Seat Map — Case Study

**Case Study ID:** CS-LLD-O55
**Track:** Classic OOD
**Companies:** Airlines, Expedia
**Difficulty:** Medium
**Related question:** [Q55-flight-seat-map.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q55-flight-seat-map.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Flight Seat Map domain

This case study examines **Flight Seat Map** — a system type commonly built at Airlines and similar organizations. Design airline seat map: seat types, selection, hold, confirm.
...
| Must | SeatMapService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Flight Seat Map.  
...
**MVP success criteria for Flight Seat Map:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Flight Seat Map**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Flight Seat Map domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q55-flight-seat-map.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q55-flight-seat-map.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/flight-seat-map/) (full)
