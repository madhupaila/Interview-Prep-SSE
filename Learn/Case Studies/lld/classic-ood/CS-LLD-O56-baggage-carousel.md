# Baggage Carousel — Case Study

**Case Study ID:** CS-LLD-O56
**Track:** Classic OOD
**Companies:** Airports
**Difficulty:** Easy
**Related question:** [Q56-baggage-carousel.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q56-baggage-carousel.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Baggage Carousel domain

This case study examines **Baggage Carousel** — a system type commonly built at Airports and similar organizations. Design baggage carousel: load bags, notify passenger, claim verification.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Baggage Carousel.  
...
**MVP success criteria for Baggage Carousel:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Baggage Carousel**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Baggage Carousel domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q56-baggage-carousel.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q56-baggage-carousel.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/baggage-carousel/) (skeleton)
