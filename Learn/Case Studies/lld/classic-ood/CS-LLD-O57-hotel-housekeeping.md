# Hotel Housekeeping — Case Study

**Case Study ID:** CS-LLD-O57
**Track:** Classic OOD
**Companies:** Marriott, Hilton
**Difficulty:** Medium
**Related question:** [Q57-hotel-housekeeping.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q57-hotel-housekeeping.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Hotel Housekeeping domain

This case study examines **Hotel Housekeeping** — a system type commonly built at Marriott and similar organizations. Design housekeeping: room status, task assignment, inspect, DND.
...
| Must | HousekeepingService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Hotel Housekeeping.  
...
**MVP success criteria for Hotel Housekeeping:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Hotel Housekeeping**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Hotel Housekeeping domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q57-hotel-housekeeping.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q57-hotel-housekeeping.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/hotel-housekeeping/) (skeleton)
