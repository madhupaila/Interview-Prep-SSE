...
**Case Study ID:** CS-LLD-O59
**Track:** Classic OOD
**Companies:** LinkedIn, Meta
**Difficulty:** Medium
**Related question:** [Q59-linkedin-post.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q59-linkedin-post.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the LinkedIn Post domain

This case study examines **LinkedIn Post** — a system type commonly built at LinkedIn and similar organizations. Design professional post: text, mentions, visibility, engagement counts.
...
| Must | PostService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for LinkedIn Post.  
...
**MVP success criteria for LinkedIn Post:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **LinkedIn Post**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the LinkedIn Post domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q59-linkedin-post.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q59-linkedin-post.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/linkedin-post/) (skeleton)
