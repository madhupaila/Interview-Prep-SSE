...
**Case Study ID:** CS-LLD-O60
**Track:** Classic OOD
**Companies:** PayPal, Apple Pay
**Difficulty:** Medium
**Related question:** [Q60-digital-wallet.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q60-digital-wallet.md)

---

## Part 1 — Business Context

**Industry analog:** PayPal wallet and ledger

This case study examines **Digital Wallet** — a system type commonly built at PayPal and similar organizations. Design wallet: balance, P2P transfer, transaction history, KYC stub.
...
| Must | WalletService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Digital Wallet.  
...
**MVP success criteria for Digital Wallet:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Digital Wallet**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | PayPal wallet and ledger (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q60-digital-wallet.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q60-digital-wallet.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/digital-wallet/) (full)
