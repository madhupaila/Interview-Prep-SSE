# Online Judge — Case Study

**Case Study ID:** CS-LLD-O61
**Track:** Classic OOD
**Companies:** LeetCode, HackerRank
**Difficulty:** Hard
**Related question:** [Q61-online-judge.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q61-online-judge.md)
...
**Industry analog:** LeetCode — submit, compile, run, verdict

This case study examines **Online Judge** — a system type commonly built at LeetCode and similar organizations. Design code judge: submit solution, compile, run tests, verdict.
...
| Must | JudgeService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Online Judge.  
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/online-judge/) (skeleton)
