# Pastebin (OOD) — Case Study

**Case Study ID:** CS-LLD-O62
**Track:** Classic OOD
**Companies:** Pastebin, GitHub Gist
**Difficulty:** Medium
**Related question:** [Q62-pastebin-ood.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q62-pastebin-ood.md)

---

## Part 1 — Business Context

**Industry analog:** Pastebin object model — paste, expiry, visibility

This case study examines **Pastebin (OOD)** — a system type commonly built at Pastebin and similar organizations. Design pastebin: create paste, short URL, expiry, privacy.
...
| Must | PastebinService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Pastebin (OOD).  
...
**MVP success criteria for Pastebin (OOD):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Pastebin (OOD)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Pastebin object model — paste, expiry, visibility (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q62-pastebin-ood.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q62-pastebin-ood.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/pastebin-ood/) (skeleton)
