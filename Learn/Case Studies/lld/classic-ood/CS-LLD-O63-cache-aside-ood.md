# Cache-Aside Pattern (Object) — Case Study

**Case Study ID:** CS-LLD-O63
**Track:** Classic OOD
**Companies:** Amazon, Redis Labs
**Difficulty:** Medium
**Related question:** [Q63-cache-aside-ood.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q63-cache-aside-ood.md)

---

## Part 1 — Business Context

**Industry analog:** Redis cache-aside at object level

This case study examines **Cache-Aside Pattern (Object)** — a system type commonly built at Amazon and similar organizations. Design cache-aside loader: read-through, write-invalidate, stampede guard.
...
| Must | CacheAsideService handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Cache-Aside Pattern (Object).  
...
**MVP success criteria for Cache-Aside Pattern (Object):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Cache-Aside Pattern (Object)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Redis cache-aside at object level (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q63-cache-aside-ood.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q63-cache-aside-ood.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/cache-aside-ood/) (full)
