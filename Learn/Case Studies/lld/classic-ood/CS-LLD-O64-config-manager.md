# Config Manager — Case Study

**Case Study ID:** CS-LLD-O64
**Track:** Classic OOD
**Companies:** Netflix, Spring
**Difficulty:** Medium
**Related question:** [Q64-config-manager.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q64-config-manager.md)

---

## Part 1 — Business Context

**Industry analog:** Netflix Archaius dynamic config

This case study examines **Config Manager** — a system type commonly built at Netflix and similar organizations. Design dynamic config: key-value, environment overrides, change listeners.
...
| Must | ConfigManager handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Config Manager.  
...
**MVP success criteria for Config Manager:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Config Manager**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Netflix Archaius dynamic config (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q64-config-manager.md](../../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q64-config-manager.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/classic/config-manager/) (full)
