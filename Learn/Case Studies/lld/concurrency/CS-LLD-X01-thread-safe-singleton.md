# Thread-Safe Singleton — Case Study

**Case Study ID:** CS-LLD-X01
**Track:** Concurrency LLD
**Companies:** Amazon, Google, Microsoft
**Difficulty:** Medium
**Related question:** [Q01-thread-safe-singleton.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q01-thread-safe-singleton.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Thread-Safe Singleton domain

This case study examines **Thread-Safe Singleton** — a system type commonly built at Amazon and similar organizations. Implement thread-safe singleton with double-checked locking or enum idiom.
...
| Must | getInstance() returns same instance across all threads | Verified in integration tests |
| Must | Lazy initialization on first access | Verified in integration tests |
| Must | Thread-safe without global synchronized bottleneck after init | Verified in integration tests |
| Must | Prevent duplicate instance via private constructor | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Thread-Safe Singleton.  
...
**MVP success criteria for Thread-Safe Singleton:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Thread-Safe Singleton**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Thread-Safe Singleton domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q01-thread-safe-singleton.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q01-thread-safe-singleton.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/concurrency/thread-safe-singleton/) (full)
