# Bounded Blocking Queue — Case Study

**Case Study ID:** CS-LLD-X02
**Track:** Concurrency LLD
**Companies:** Amazon, LinkedIn
**Difficulty:** Hard
**Related question:** [Q02-bounded-blocking-queue.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q02-bounded-blocking-queue.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Bounded Blocking Queue domain

This case study examines **Bounded Blocking Queue** — a system type commonly built at Amazon and similar organizations. Design bounded blocking queue with put/take blocking on full/empty.
...
| Must | BoundedBlockingQueue handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Bounded Blocking Queue.  
...
**MVP success criteria for Bounded Blocking Queue:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Bounded Blocking Queue**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Bounded Blocking Queue domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q02-bounded-blocking-queue.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q02-bounded-blocking-queue.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/concurrency/bounded-blocking-queue/) (full)
