# Reader-Writer Lock — Case Study

**Case Study ID:** CS-LLD-X04
**Track:** Concurrency LLD
**Companies:** Amazon, Google
**Difficulty:** Hard
**Related question:** [Q04-reader-writer-lock.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q04-reader-writer-lock.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Reader-Writer Lock domain

This case study examines **Reader-Writer Lock** — a system type commonly built at Amazon and similar organizations. Design read-write lock allowing concurrent readers OR exclusive writer.
...
| Must | ReadWriteLock handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Reader-Writer Lock.  
...
**MVP success criteria for Reader-Writer Lock:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Reader-Writer Lock**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Reader-Writer Lock domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q04-reader-writer-lock.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q04-reader-writer-lock.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/concurrency/reader-writer-lock/) (full)
