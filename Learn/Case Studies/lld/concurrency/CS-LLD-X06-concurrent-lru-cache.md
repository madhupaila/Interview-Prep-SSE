# Concurrent LRU Cache — Case Study

**Case Study ID:** CS-LLD-X06
**Track:** Concurrency LLD
**Companies:** Amazon, Meta
**Difficulty:** Hard
**Related question:** [Q06-concurrent-lru-cache.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q06-concurrent-lru-cache.md)

---

## Part 1 — Business Context

**Industry analog:** Caffeine cache concurrent eviction

This case study examines **Concurrent LRU Cache** — a system type commonly built at Amazon and similar organizations. Design thread-safe LRU cache with fine-grained locking or ConcurrentHashMap.
...
| Must | ConcurrentLRUCache handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Concurrent LRU Cache.  
...
**MVP success criteria for Concurrent LRU Cache:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Concurrent LRU Cache**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Caffeine cache concurrent eviction (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q06-concurrent-lru-cache.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q06-concurrent-lru-cache.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/concurrency/concurrent-lru-cache/) (full)
