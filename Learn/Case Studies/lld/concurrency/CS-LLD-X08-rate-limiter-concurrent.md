# Rate Limiter (Concurrent) — Case Study

**Case Study ID:** CS-LLD-X08
**Track:** Concurrency LLD
**Companies:** Stripe, Cloudflare
**Difficulty:** Medium
**Related question:** [Q08-rate-limiter-concurrent.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q08-rate-limiter-concurrent.md)
...
This case study examines **Rate Limiter (Concurrent)** — a system type commonly built at Stripe and similar organizations. Design distributed-safe token bucket rate limiter with atomic updates.
...
| Must | ConcurrentRateLimiter handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Rate Limiter (Concurrent).  
...
- **Question file:** [Q08-rate-limiter-concurrent.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q08-rate-limiter-concurrent.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/concurrency/rate-limiter-concurrent/) (full)
