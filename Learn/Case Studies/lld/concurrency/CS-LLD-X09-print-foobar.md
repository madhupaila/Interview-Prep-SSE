# Print FooBar Alternating — Case Study

**Case Study ID:** CS-LLD-X09
**Track:** Concurrency LLD
**Companies:** Amazon, Google
**Difficulty:** Medium
**Related question:** [Q09-print-foobar.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q09-print-foobar.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Print FooBar Alternating domain

This case study examines **Print FooBar Alternating** — a system type commonly built at Amazon and similar organizations. Design two threads printing foo/bar alternately n times using locks.
...
| Must | FooBarPrinter handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Print FooBar Alternating.  
...
**MVP success criteria for Print FooBar Alternating:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Print FooBar Alternating**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Print FooBar Alternating domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q09-print-foobar.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q09-print-foobar.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/concurrency/print-foobar/) (full)
