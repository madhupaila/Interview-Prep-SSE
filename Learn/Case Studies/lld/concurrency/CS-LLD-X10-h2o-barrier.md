# H2O Barrier — Case Study

**Case Study ID:** CS-LLD-X10
**Track:** Concurrency LLD
**Companies:** Google, Amazon
**Difficulty:** Medium
**Related question:** [Q10-h2o-barrier.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q10-h2o-barrier.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the H2O Barrier domain

This case study examines **H2O Barrier** — a system type commonly built at Google and similar organizations. Design barrier synchronizing H, O threads to form H2O molecules.
...
| Must | H2OSynchronizer handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for H2O Barrier.  
...
**MVP success criteria for H2O Barrier:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **H2O Barrier**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the H2O Barrier domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q10-h2o-barrier.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q10-h2o-barrier.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/concurrency/h2o-barrier/) (full)
