# Web Crawler (Multithreaded) — Case Study

**Case Study ID:** CS-LLD-X11
**Track:** Concurrency LLD
**Companies:** Google, Microsoft
**Difficulty:** Hard
**Related question:** [Q11-web-crawler-multithreaded.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q11-web-crawler-multithreaded.md)
...
**Industry analog:** Googlebot — parallel fetch with URL frontier

This case study examines **Web Crawler (Multithreaded)** — a system type commonly built at Google and similar organizations. Design multi-threaded crawler with visited set, URL frontier, politeness.
...
| Must | WebCrawler handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Web Crawler (Multithreaded).  
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/concurrency/web-crawler-multithreaded/) (full)
