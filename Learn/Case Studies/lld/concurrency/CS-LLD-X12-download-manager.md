# Download Manager — Case Study

**Case Study ID:** CS-LLD-X12
**Track:** Concurrency LLD
**Companies:** Microsoft, Apple
**Difficulty:** Medium
**Related question:** [Q12-download-manager.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q12-download-manager.md)

---

## Part 1 — Business Context

**Industry analog:** Internet Download Manager parallel chunks

This case study examines **Download Manager** — a system type commonly built at Microsoft and similar organizations. Design concurrent download manager with chunks, progress, pause/resume.
...
| Must | DownloadManager handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Download Manager.  
...
**MVP success criteria for Download Manager:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Download Manager**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Internet Download Manager parallel chunks (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q12-download-manager.md](../../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q12-download-manager.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/concurrency/download-manager/) (full)
