# Strategy — Payment Gateways — Case Study

**Case Study ID:** CS-LLD-P01
**Track:** Design Patterns
**Companies:** Stripe, Amazon, PayPal
**Difficulty:** Medium
**Related question:** [Q01-strategy-payment.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q01-strategy-payment.md)
**Java implementation:** [strategy-payment](../../../System Design - Low Level Design/09-code-implementations/java/classic/parking-lot/strategy/ParkingStrategy.java)

---

## Part 1 — Business Context

**Industry analog:** Stripe multi-gateway payment routing

This case study examines **Strategy — Payment Gateways** — a system type commonly built at Stripe and similar organizations. Design payment processing with swappable gateways (Stripe, PayPal, Apple Pay).
...
| Must | PaymentProcessor handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Strategy — Payment Gateways.  
...
**MVP success criteria for Strategy — Payment Gateways:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Strategy — Payment Gateways**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Stripe multi-gateway payment routing (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q01-strategy-payment.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q01-strategy-payment.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/strategy-payment/) (full)
