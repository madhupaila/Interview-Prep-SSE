# Factory — Vehicle Creator — Case Study

**Case Study ID:** CS-LLD-P02
**Track:** Design Patterns
**Companies:** Tesla, Ford, Toyota
**Difficulty:** Medium
**Related question:** [Q02-factory-vehicle.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q02-factory-vehicle.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Factory — Vehicle Creator domain

This case study examines **Factory — Vehicle Creator** — a system type commonly built at Tesla and similar organizations. Design factory creating Car, Truck, Motorcycle from VehicleType enum.
...
| Must | VehicleFactory handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Factory — Vehicle Creator.  
...
**MVP success criteria for Factory — Vehicle Creator:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Factory — Vehicle Creator**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Factory — Vehicle Creator domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q02-factory-vehicle.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q02-factory-vehicle.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/factory-vehicle/) (full)
