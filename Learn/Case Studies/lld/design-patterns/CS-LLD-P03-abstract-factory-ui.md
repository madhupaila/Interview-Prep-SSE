# Abstract Factory — UI Themes — Case Study

**Case Study ID:** CS-LLD-P03
**Track:** Design Patterns
**Companies:** Adobe, Microsoft
**Difficulty:** Hard
**Related question:** [Q03-abstract-factory-ui.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q03-abstract-factory-ui.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Abstract Factory — UI Themes domain

This case study examines **Abstract Factory — UI Themes** — a system type commonly built at Adobe and similar organizations. Design abstract factory for Light/Dark UI component families (Button, Checkbox).
...
| Must | UIFactory handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Abstract Factory — UI Themes.  
...
**MVP success criteria for Abstract Factory — UI Themes:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Abstract Factory — UI Themes**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Abstract Factory — UI Themes domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q03-abstract-factory-ui.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q03-abstract-factory-ui.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/abstract-factory-ui/) (full)
