# Builder — Meal Combo — Case Study

**Case Study ID:** CS-LLD-P04
**Track:** Design Patterns
**Companies:** McDonald's, Starbucks
**Difficulty:** Medium
**Related question:** [Q04-builder-meal.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q04-builder-meal.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Builder — Meal Combo domain

This case study examines **Builder — Meal Combo** — a system type commonly built at McDonald's and similar organizations. Design builder for meal combos: burger, drink, fries step-by-step.
...
| Must | MealBuilder handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Builder — Meal Combo.  
...
**MVP success criteria for Builder — Meal Combo:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Builder — Meal Combo**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Builder — Meal Combo domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q04-builder-meal.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q04-builder-meal.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/builder-meal/) (full)
