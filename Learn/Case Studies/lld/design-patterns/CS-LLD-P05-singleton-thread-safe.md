# Singleton — Thread-Safe Config — Case Study

**Case Study ID:** CS-LLD-P05
**Track:** Design Patterns
**Companies:** Amazon, Spring
**Difficulty:** Medium
**Related question:** [Q05-singleton-thread-safe.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q05-singleton-thread-safe.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Singleton — Thread-Safe Config domain

This case study examines **Singleton — Thread-Safe Config** — a system type commonly built at Amazon and similar organizations. Design thread-safe singleton config holder with lazy initialization.
...
| Must | AppConfig handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Singleton — Thread-Safe Config.  
...
**MVP success criteria for Singleton — Thread-Safe Config:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Singleton — Thread-Safe Config**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Singleton — Thread-Safe Config domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q05-singleton-thread-safe.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q05-singleton-thread-safe.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/singleton-thread-safe/) (full)
