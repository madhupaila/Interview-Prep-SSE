# Prototype — Game Board Clone — Case Study

**Case Study ID:** CS-LLD-P06
**Track:** Design Patterns
**Companies:** EA, Unity
**Difficulty:** Medium
**Related question:** [Q06-prototype-game-board.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q06-prototype-game-board.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Prototype — Game Board Clone domain

This case study examines **Prototype — Game Board Clone** — a system type commonly built at EA and similar organizations. Design prototype pattern to clone complex game boards for save/replay.
...
| Must | Execute game turns with rule validation | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Prototype — Game Board Clone.  
...
**MVP success criteria for Prototype — Game Board Clone:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Prototype — Game Board Clone**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Prototype — Game Board Clone domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q06-prototype-game-board.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q06-prototype-game-board.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/prototype-game-board/) (full)
