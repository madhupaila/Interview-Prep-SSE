# Adapter — Legacy Payment API — Case Study

**Case Study ID:** CS-LLD-P07
**Track:** Design Patterns
**Companies:** Banks, Stripe
**Difficulty:** Medium
**Related question:** [Q07-adapter-legacy-payment.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q07-adapter-legacy-payment.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Adapter — Legacy Payment API domain

This case study examines **Adapter — Legacy Payment API** — a system type commonly built at Banks and similar organizations. Design adapter wrapping legacy XML payment API behind modern interface.
...
| Must | PaymentAdapter handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Adapter — Legacy Payment API.  
...
**MVP success criteria for Adapter — Legacy Payment API:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Adapter — Legacy Payment API**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Adapter — Legacy Payment API domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q07-adapter-legacy-payment.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q07-adapter-legacy-payment.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/adapter-legacy-payment/) (full)
