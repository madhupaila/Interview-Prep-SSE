# Facade — Home Theater — Case Study

**Case Study ID:** CS-LLD-P09
**Track:** Design Patterns
**Companies:** Sony, Samsung
**Difficulty:** Medium
**Related question:** [Q09-facade-home-theater.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q09-facade-home-theater.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Facade — Home Theater domain

This case study examines **Facade — Home Theater** — a system type commonly built at Sony and similar organizations. Design facade orchestrating amp, projector, screen, lights for watchMovie().
...
| Must | HomeTheaterFacade handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Facade — Home Theater.  
...
**MVP success criteria for Facade — Home Theater:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Facade — Home Theater**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Facade — Home Theater domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q09-facade-home-theater.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q09-facade-home-theater.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/facade-home-theater/) (full)
