# Proxy — Image Loader — Case Study

**Case Study ID:** CS-LLD-P10
**Track:** Design Patterns
**Companies:** Google, Meta
**Difficulty:** Medium
**Related question:** [Q10-proxy-image-loader.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q10-proxy-image-loader.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Proxy — Image Loader domain

This case study examines **Proxy — Image Loader** — a system type commonly built at Google and similar organizations. Design virtual proxy lazy-loading high-res images with placeholder.
...
| Must | ImageProxy handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Proxy — Image Loader.  
...
**MVP success criteria for Proxy — Image Loader:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Proxy — Image Loader**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Proxy — Image Loader domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q10-proxy-image-loader.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q10-proxy-image-loader.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/proxy-image-loader/) (full)
