# Composite — Org Chart — Case Study

**Case Study ID:** CS-LLD-P11
**Track:** Design Patterns
**Companies:** Workday, SAP
**Difficulty:** Medium
**Related question:** [Q11-composite-org-chart.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q11-composite-org-chart.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Composite — Org Chart domain

This case study examines **Composite — Org Chart** — a system type commonly built at Workday and similar organizations. Design composite for org chart: Employee leaf and Department composite.
...
| Must | OrgComposite handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Composite — Org Chart.  
...
**MVP success criteria for Composite — Org Chart:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Composite — Org Chart**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Composite — Org Chart domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q11-composite-org-chart.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q11-composite-org-chart.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/composite-org-chart/) (full)
