# Bridge — Remote Control — Case Study

**Case Study ID:** CS-LLD-P12
**Track:** Design Patterns
**Companies:** Samsung, LG
**Difficulty:** Medium
**Related question:** [Q12-bridge-remote-control.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q12-bridge-remote-control.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Bridge — Remote Control domain

This case study examines **Bridge — Remote Control** — a system type commonly built at Samsung and similar organizations. Design bridge separating remote abstraction from device implementation.
...
| Must | RemoteBridge handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Bridge — Remote Control.  
...
**MVP success criteria for Bridge — Remote Control:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Bridge — Remote Control**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Bridge — Remote Control domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q12-bridge-remote-control.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q12-bridge-remote-control.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/bridge-remote-control/) (full)
