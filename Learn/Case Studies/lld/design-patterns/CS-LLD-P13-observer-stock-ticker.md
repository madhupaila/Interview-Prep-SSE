# Observer — Stock Price Feed — Case Study

**Case Study ID:** CS-LLD-P13
**Track:** Design Patterns
**Companies:** Bloomberg, Robinhood
**Difficulty:** Medium
**Related question:** [Q13-observer-stock-ticker.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q13-observer-stock-ticker.md)

---

## Part 1 — Business Context

**Industry analog:** Bloomberg real-time price feeds

This case study examines **Observer — Stock Price Feed** — a system type commonly built at Bloomberg and similar organizations. Design observer for stock price updates to multiple display widgets.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Observer — Stock Price Feed.  
...
**MVP success criteria for Observer — Stock Price Feed:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Observer — Stock Price Feed**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Bloomberg real-time price feeds (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q13-observer-stock-ticker.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q13-observer-stock-ticker.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/observer-stock-ticker/) (full)
