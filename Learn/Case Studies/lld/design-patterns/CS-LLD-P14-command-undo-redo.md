# Command — Undo/Redo — Case Study

**Case Study ID:** CS-LLD-P14
**Track:** Design Patterns
**Companies:** Adobe, Microsoft
**Difficulty:** Medium
**Related question:** [Q14-command-undo-redo.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q14-command-undo-redo.md)

---

## Part 1 — Business Context

**Industry analog:** Photoshop and Google Docs undo stack

This case study examines **Command — Undo/Redo** — a system type commonly built at Adobe and similar organizations. Design command pattern with undo/redo stack for text editor actions.
...
| Must | CommandManager handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Command — Undo/Redo.  
...
**MVP success criteria for Command — Undo/Redo:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Command — Undo/Redo**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Photoshop and Google Docs undo stack (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q14-command-undo-redo.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q14-command-undo-redo.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/command-undo-redo/) (full)
