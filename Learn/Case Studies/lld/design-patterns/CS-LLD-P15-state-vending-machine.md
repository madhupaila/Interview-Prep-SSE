# State — Vending Machine — Case Study

**Case Study ID:** CS-LLD-P15
**Track:** Design Patterns
**Companies:** Amazon, Coca-Cola
**Difficulty:** Medium
**Related question:** [Q15-state-vending-machine.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q15-state-vending-machine.md)

---

## Part 1 — Business Context

**Industry analog:** Automated retail state machines

This case study examines **State — Vending Machine** — a system type commonly built at Amazon and similar organizations. Design state pattern for vending machine phases: idle, coin, dispense.
...
| Must | VendingStateMachine handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for State — Vending Machine.  
...
**MVP success criteria for State — Vending Machine:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **State — Vending Machine**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Automated retail state machines (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q15-state-vending-machine.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q15-state-vending-machine.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/state-vending-machine/) (full)
