# Template Method — Data Parser — Case Study

**Case Study ID:** CS-LLD-P16
**Track:** Design Patterns
**Companies:** Apache, Elastic
**Difficulty:** Medium
**Related question:** [Q16-template-method-parser.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q16-template-method-parser.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Template Method — Data Parser domain

This case study examines **Template Method — Data Parser** — a system type commonly built at Apache and similar organizations. Design template method for CSV/JSON parsers sharing open-read-parse-close skeleton.
...
| Must | DataParser handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Template Method — Data Parser.  
...
**MVP success criteria for Template Method — Data Parser:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Template Method — Data Parser**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Template Method — Data Parser domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q16-template-method-parser.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q16-template-method-parser.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/template-method-parser/) (full)
