# Iterator — Playlist — Case Study

**Case Study ID:** CS-LLD-P17
**Track:** Design Patterns
**Companies:** Spotify, Apple
**Difficulty:** Medium
**Related question:** [Q17-iterator-playlist.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q17-iterator-playlist.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Iterator — Playlist domain

This case study examines **Iterator — Playlist** — a system type commonly built at Spotify and similar organizations. Design custom iterator traversing playlist forward/backward/shuffle.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Iterator — Playlist.  
...
**MVP success criteria for Iterator — Playlist:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Iterator — Playlist**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Iterator — Playlist domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q17-iterator-playlist.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q17-iterator-playlist.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/iterator-playlist/) (full)
