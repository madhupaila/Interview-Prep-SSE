# Chain of Responsibility — Support — Case Study

**Case Study ID:** CS-LLD-P18
**Track:** Design Patterns
**Companies:** Amazon, Zendesk
**Difficulty:** Medium
**Related question:** [Q18-chain-support-tickets.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q18-chain-support-tickets.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Chain of Responsibility — Support domain

This case study examines **Chain of Responsibility — Support** — a system type commonly built at Amazon and similar organizations. Design support ticket escalation: L1 → L2 → L3 handler chain.
...
| Must | SupportChain handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Chain of Responsibility — Support.  
...
**MVP success criteria for Chain of Responsibility — Support:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Chain of Responsibility — Support**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Chain of Responsibility — Support domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q18-chain-support-tickets.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q18-chain-support-tickets.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/chain-support-tickets/) (full)
