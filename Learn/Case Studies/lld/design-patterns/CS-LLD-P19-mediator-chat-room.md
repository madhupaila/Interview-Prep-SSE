# Mediator — Chat Room — Case Study

**Case Study ID:** CS-LLD-P19
**Track:** Design Patterns
**Companies:** Discord, Slack
**Difficulty:** Medium
**Related question:** [Q19-mediator-chat-room.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q19-mediator-chat-room.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Mediator — Chat Room domain

This case study examines **Mediator — Chat Room** — a system type commonly built at Discord and similar organizations. Design mediator so users send messages through chat room, not peer-to-peer.
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Mediator — Chat Room.  
...
**MVP success criteria for Mediator — Chat Room:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Mediator — Chat Room**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Mediator — Chat Room domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q19-mediator-chat-room.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q19-mediator-chat-room.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/mediator-chat-room/) (full)
