# Flyweight — Forest Scene — Case Study

**Case Study ID:** CS-LLD-P21
**Track:** Design Patterns
**Companies:** Unity, EA
**Difficulty:** Medium
**Related question:** [Q21-flyweight-forest.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q21-flyweight-forest.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Flyweight — Forest Scene domain

This case study examines **Flyweight — Forest Scene** — a system type commonly built at Unity and similar organizations. Design flyweight sharing tree intrinsic state (type) across thousands of instances.
...
| Must | TreeFlyweight handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Flyweight — Forest Scene.  
...
**MVP success criteria for Flyweight — Forest Scene:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Flyweight — Forest Scene**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Flyweight — Forest Scene domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q21-flyweight-forest.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q21-flyweight-forest.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/flyweight-forest/) (full)
