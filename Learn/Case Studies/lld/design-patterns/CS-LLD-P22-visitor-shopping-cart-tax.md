# Visitor — Cart Tax — Case Study

**Case Study ID:** CS-LLD-P22
**Track:** Design Patterns
**Companies:** Amazon, Intuit
**Difficulty:** Medium
**Related question:** [Q22-visitor-shopping-cart-tax.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q22-visitor-shopping-cart-tax.md)

---

## Part 1 — Business Context

**Industry analog:** Amazon cart and checkout session

This case study examines **Visitor — Cart Tax** — a system type commonly built at Amazon and similar organizations. Design visitor computing tax for mixed cart item types without double dispatch mess.
...
| Must | TaxVisitor handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Visitor — Cart Tax.  
...
**MVP success criteria for Visitor — Cart Tax:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Visitor — Cart Tax**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Amazon cart and checkout session (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q22-visitor-shopping-cart-tax.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q22-visitor-shopping-cart-tax.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/visitor-shopping-cart-tax/) (full)
