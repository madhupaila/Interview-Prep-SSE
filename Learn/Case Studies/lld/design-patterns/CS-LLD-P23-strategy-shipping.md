# Strategy — Shipping Calculator — Case Study

**Case Study ID:** CS-LLD-P23
**Track:** Design Patterns
**Companies:** Amazon, FedEx
**Difficulty:** Medium
**Related question:** [Q23-strategy-shipping.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q23-strategy-shipping.md)
**Java implementation:** [strategy-shipping](../../../System Design - Low Level Design/09-code-implementations/java/classic/parking-lot/strategy/ParkingStrategy.java)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Strategy — Shipping Calculator domain

This case study examines **Strategy — Shipping Calculator** — a system type commonly built at Amazon and similar organizations. Design shipping cost strategies: standard, express, overnight by weight/zone.
...
| Must | ShippingCalculator handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Strategy — Shipping Calculator.  
...
**MVP success criteria for Strategy — Shipping Calculator:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Strategy — Shipping Calculator**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Strategy — Shipping Calculator domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q23-strategy-shipping.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q23-strategy-shipping.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/strategy-shipping/) (full)
