# Factory — Document Creator — Case Study

**Case Study ID:** CS-LLD-P24
**Track:** Design Patterns
**Companies:** Microsoft, Google
**Difficulty:** Medium
**Related question:** [Q24-factory-document.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q24-factory-document.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Factory — Document Creator domain

This case study examines **Factory — Document Creator** — a system type commonly built at Microsoft and similar organizations. Design factory method creating PDF, Word, Markdown documents.
...
| Must | DocumentFactory handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Factory — Document Creator.  
...
**MVP success criteria for Factory — Document Creator:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Factory — Document Creator**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Factory — Document Creator domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q24-factory-document.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q24-factory-document.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/factory-document/) (full)
