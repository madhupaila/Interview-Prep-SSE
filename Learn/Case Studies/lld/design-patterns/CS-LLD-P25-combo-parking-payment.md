# Combo — Parking + Payment — Case Study

**Case Study ID:** CS-LLD-P25
**Track:** Design Patterns
**Companies:** Amazon, Stripe
**Difficulty:** Hard
**Related question:** [Q25-combo-parking-payment.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q25-combo-parking-payment.md)

---

## Part 1 — Business Context

**Industry analog:** Leading products in the Combo — Parking + Payment domain

This case study examines **Combo — Parking + Payment** — a system type commonly built at Amazon and similar organizations. Combine Strategy (allocation + payment) and Factory (vehicle) in parking lot.
...
| Must | Park and unpark with spot assignment | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Combo — Parking + Payment.  
...
**MVP success criteria for Combo — Parking + Payment:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Combo — Parking + Payment**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Leading products in the Combo — Parking + Payment domain (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q25-combo-parking-payment.md](../../../System%20Design%20-%20Low%20Level%20Design/03-design-patterns/questions/Q25-combo-parking-payment.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/patterns/combo-parking-payment/) (full)
