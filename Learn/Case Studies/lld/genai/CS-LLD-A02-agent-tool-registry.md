# Agent Tool Registry — Case Study

**Case Study ID:** CS-LLD-A02
**Track:** Gen AI LLD
**Companies:** Anthropic, OpenAI
**Difficulty:** Hard
**Related question:** [Q02-agent-tool-registry.md](../../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q02-agent-tool-registry.md)
...
**Industry analog:** OpenAI function calling and tool schemas

This case study examines **Agent Tool Registry** — a system type commonly built at Anthropic and similar organizations. Design tool registry for LLM agents: register, describe, invoke, validate args.
...
| Must | ToolRegistry handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Agent Tool Registry.  
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/genai/agent-tool-registry/) (full)
