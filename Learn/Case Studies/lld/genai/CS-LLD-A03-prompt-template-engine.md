# Prompt Template Engine — Case Study

**Case Study ID:** CS-LLD-A03
**Track:** Gen AI LLD
**Companies:** LangChain, OpenAI
**Difficulty:** Medium
**Related question:** [Q03-prompt-template-engine.md](../../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q03-prompt-template-engine.md)
...
**Industry analog:** Jinja2-style prompt templates with variables

This case study examines **Prompt Template Engine** — a system type commonly built at LangChain and similar organizations. Design prompt templates with variables, conditionals, and partials.
...
| Must | PromptEngine handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Prompt Template Engine.  
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/genai/prompt-template-engine/) (skeleton)
