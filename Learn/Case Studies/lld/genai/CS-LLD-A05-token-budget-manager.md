# Token Budget Manager — Case Study

**Case Study ID:** CS-LLD-A05
**Track:** Gen AI LLD
**Companies:** OpenAI, Anthropic
**Difficulty:** Medium
**Related question:** [Q05-token-budget-manager.md](../../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q05-token-budget-manager.md)
...
**Industry analog:** OpenAI token counting and context window limits

This case study examines **Token Budget Manager** — a system type commonly built at OpenAI and similar organizations. Design token budget allocator across system, history, retrieval, response.
...
| Must | TokenBudgetManager handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Token Budget Manager.  
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/genai/token-budget-manager/) (skeleton)
