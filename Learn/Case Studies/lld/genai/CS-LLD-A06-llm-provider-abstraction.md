# LLM Provider Abstraction — Case Study

**Case Study ID:** CS-LLD-A06
**Track:** Gen AI LLD
**Companies:** Anthropic, OpenAI
**Difficulty:** Medium
**Related question:** [Q06-llm-provider-abstraction.md](../../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q06-llm-provider-abstraction.md)
...
**Industry analog:** LiteLLM — unified provider interface

This case study examines **LLM Provider Abstraction** — a system type commonly built at Anthropic and similar organizations. Design provider interface swapping OpenAI, Anthropic, local models.
...
| Must | LLMProvider handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for LLM Provider Abstraction.  
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/genai/llm-provider-abstraction/) (full)
