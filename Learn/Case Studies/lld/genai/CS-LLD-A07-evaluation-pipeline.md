# Evaluation Pipeline — Case Study

**Case Study ID:** CS-LLD-A07
**Track:** Gen AI LLD
**Companies:** OpenAI, HuggingFace
**Difficulty:** Hard
**Related question:** [Q07-evaluation-pipeline.md](../../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q07-evaluation-pipeline.md)
...
**Industry analog:** OpenAI evals and HuggingFace Evaluate

This case study examines **Evaluation Pipeline** — a system type commonly built at OpenAI and similar organizations. Design LLM eval pipeline: dataset, metrics, judge model, report.
...
| Must | EvalPipeline handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Evaluation Pipeline.  
...
- **Question file:** [Q07-evaluation-pipeline.md](../../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q07-evaluation-pipeline.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/genai/evaluation-pipeline/) (skeleton)
