# Guardrail / Safety Filter Chain — Case Study

**Case Study ID:** CS-LLD-A08
**Track:** Gen AI LLD
**Companies:** Anthropic, OpenAI
**Difficulty:** Hard
**Related question:** [Q08-guardrail-safety-chain.md](../../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q08-guardrail-safety-chain.md)
...
**Industry analog:** Anthropic Constitutional AI and OpenAI moderation

This case study examines **Guardrail / Safety Filter Chain** — a system type commonly built at Anthropic and similar organizations. Design chain of input/output guardrails: PII, toxicity, policy filters.
...
| Must | GuardrailChain handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Guardrail / Safety Filter Chain.  
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/genai/guardrail-safety-chain/) (full)
