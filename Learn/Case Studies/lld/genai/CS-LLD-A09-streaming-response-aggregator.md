# Streaming Response Aggregator — Case Study

**Case Study ID:** CS-LLD-A09
**Track:** Gen AI LLD
**Companies:** OpenAI, Google
**Difficulty:** Medium
**Related question:** [Q09-streaming-response-aggregator.md](../../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q09-streaming-response-aggregator.md)
**Paired case study:** [CS-PAIR-17-streaming-llm.md](../../paired/CS-PAIR-17-streaming-llm.md)

---

## Part 1 — Business Context

**Industry analog:** ChatGPT SSE streaming and token aggregation

This case study examines **Streaming Response Aggregator** — a system type commonly built at OpenAI and similar organizations. Design aggregator collecting streamed LLM tokens into final response + callbacks.
...
| Must | StreamAggregator handles primary workflow described in requirements | Verified in integration tests |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Streaming Response Aggregator.  
...
**MVP success criteria for Streaming Response Aggregator:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Streaming Response Aggregator**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | ChatGPT SSE streaming and token aggregation (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q09-streaming-response-aggregator.md](../../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q09-streaming-response-aggregator.md)
- **End-to-end pair:** [CS-PAIR-17-streaming-llm.md](../../paired/CS-PAIR-17-streaming-llm.md)
...
- [Java implementation](../../../System Design - Low Level Design/09-code-implementations/java/genai/streaming-response-aggregator/) (skeleton)
