# WhatsApp / 1:1 Messenger — End-to-End Case Study

**Case Study ID:** CS-PAIR-05
**Track:** Paired HLD + LLD
**HLD case study:** [CS-HLD-C04](../hld/classic/CS-HLD-C04-whatsapp-messenger.md)
**LLD case study:** [CS-LLD-O24](../lld/classic-ood/CS-LLD-O24-messenger-1to1.md)
**HLD question:** [Q04-whatsapp-messenger.md](../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q04-whatsapp-messenger.md)
**LLD question:** [Q24-messenger-1to1.md](../../System Design - Low Level Design/02-classic-ood/questions/Q24-messenger-1to1.md)
...
**MVP success criteria for Messenger (1:1 Chat):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Messenger (1:1 Chat)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | WhatsApp message delivery states (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q24-messenger-1to1.md](../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q24-messenger-1to1.md)
- **End-to-end pair:** [CS-PAIR-05-whatsapp-messenger.md](CS-PAIR-05-whatsapp-messenger.md)
...
- [Java implementation](../../System Design - Low Level Design/09-code-implementations/java/classic/messenger-1to1/README.md) (full)
