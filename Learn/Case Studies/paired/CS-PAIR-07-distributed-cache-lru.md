# Distributed Cache / LRU — End-to-End Case Study

**Case Study ID:** CS-PAIR-07
**Track:** Paired HLD + LLD
**HLD case study:** [CS-HLD-C12](../hld/classic/CS-HLD-C12-distributed-cache.md)
**LLD case study:** [CS-LLD-O13](../lld/classic-ood/CS-LLD-O13-lru-cache.md)
**HLD question:** [Q12-distributed-cache.md](../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q12-distributed-cache.md)
**LLD question:** [Q13-lru-cache.md](../../System Design - Low Level Design/02-classic-ood/questions/Q13-lru-cache.md)
...
**MVP success criteria for LRU Cache:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **LRU Cache**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Redis and Memcached — in-process cache vs distributed cache (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q13-lru-cache.md](../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q13-lru-cache.md)
- **End-to-end pair:** [CS-PAIR-07-distributed-cache-lru.md](CS-PAIR-07-distributed-cache-lru.md)
...
- [Java implementation](../../System Design - Low Level Design/09-code-implementations/java/classic/lru-cache/LRUCacheDemo.java) (full)
