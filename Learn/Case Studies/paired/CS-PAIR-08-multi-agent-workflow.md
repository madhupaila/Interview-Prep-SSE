# Multi-Agent Workflow Platform — End-to-End Case Study

**Case Study ID:** CS-PAIR-08
**Track:** Paired HLD + LLD
**HLD case study:** [CS-HLD-G08](../hld/genai/CS-HLD-G08-multi-agent-workflow.md)
**LLD case study:** [CS-LLD-A10](../lld/genai/CS-LLD-A10-multi-agent-coordinator.md)
**HLD question:** [Q08-multi-agent-workflow.md](../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q08-multi-agent-workflow.md)
**LLD question:** [Q10-multi-agent-coordinator.md](../../System Design - Low Level Design/05-genai-llm-lld/questions/Q10-multi-agent-coordinator.md)
...
- **Question file:** [Q10-multi-agent-coordinator.md](../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q10-multi-agent-coordinator.md)
- **End-to-end pair:** [CS-PAIR-08-multi-agent-workflow.md](CS-PAIR-08-multi-agent-workflow.md)
...
- [Java implementation](../../System Design - Low Level Design/09-code-implementations/java/genai/multi-agent-coordinator/README.md) (skeleton)
