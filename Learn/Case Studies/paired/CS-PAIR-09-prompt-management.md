# Prompt Management & Versioning — End-to-End Case Study

**Case Study ID:** CS-PAIR-09
**Track:** Paired HLD + LLD
**HLD case study:** [CS-HLD-G13](../hld/genai/CS-HLD-G13-prompt-management.md)
**LLD case study:** [CS-LLD-A03](../lld/genai/CS-LLD-A03-prompt-template-engine.md)
**HLD question:** [Q13-prompt-management.md](../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q13-prompt-management.md)
**LLD question:** [Q03-prompt-template-engine.md](../../System Design - Low Level Design/05-genai-llm-lld/questions/Q03-prompt-template-engine.md)
...
**MVP success criteria for Prompt Template Engine:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Prompt Template Engine**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Jinja2-style prompt templates with variables (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q03-prompt-template-engine.md](../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q03-prompt-template-engine.md)
- **End-to-end pair:** [CS-PAIR-09-prompt-management.md](CS-PAIR-09-prompt-management.md)
...
- [Java implementation](../../System Design - Low Level Design/09-code-implementations/java/genai/prompt-template-engine/README.md) (skeleton)
