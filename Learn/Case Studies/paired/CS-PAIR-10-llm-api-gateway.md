# LLM API Gateway / Model Router — End-to-End Case Study

**Case Study ID:** CS-PAIR-10
**Track:** Paired HLD + LLD
**HLD case study:** [CS-HLD-G05](../hld/genai/CS-HLD-G05-llm-api-gateway.md)
**LLD case study:** [CS-LLD-A06](../lld/genai/CS-LLD-A06-llm-provider-abstraction.md)
**HLD question:** [Q05-llm-api-gateway.md](../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q05-llm-api-gateway.md)
**LLD question:** [Q06-llm-provider-abstraction.md](../../System Design - Low Level Design/05-genai-llm-lld/questions/Q06-llm-provider-abstraction.md)
...
**MVP success criteria for LLM Provider Abstraction:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **LLM Provider Abstraction**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | LiteLLM — unified provider interface (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q06-llm-provider-abstraction.md](../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q06-llm-provider-abstraction.md)
- **End-to-end pair:** [CS-PAIR-10-llm-api-gateway.md](CS-PAIR-10-llm-api-gateway.md)
...
- [Java implementation](../../System Design - Low Level Design/09-code-implementations/java/genai/llm-provider-abstraction/README.md) (full)
