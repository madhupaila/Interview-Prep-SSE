# Code Assistant (Copilot-like) — End-to-End Case Study

**Case Study ID:** CS-PAIR-11
**Track:** Paired HLD + LLD
**HLD case study:** [CS-HLD-G03](../hld/genai/CS-HLD-G03-code-assistant-copilot.md)
**LLD case study:** [CS-LLD-A02](../lld/genai/CS-LLD-A02-agent-tool-registry.md)
**HLD question:** [Q03-code-assistant-copilot.md](../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q03-code-assistant-copilot.md)
**LLD question:** [Q02-agent-tool-registry.md](../../System Design - Low Level Design/05-genai-llm-lld/questions/Q02-agent-tool-registry.md)
...
**MVP success criteria for Agent Tool Registry:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Agent Tool Registry**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | OpenAI function calling and tool schemas (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q02-agent-tool-registry.md](../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q02-agent-tool-registry.md)
- **End-to-end pair:** [CS-PAIR-11-code-assistant-copilot.md](CS-PAIR-11-code-assistant-copilot.md)
...
- [Java implementation](../../System Design - Low Level Design/09-code-implementations/java/genai/agent-tool-registry/README.md) (full)
