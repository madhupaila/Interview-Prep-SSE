# Uber Ride Sharing — End-to-End Case Study

**Case Study ID:** CS-PAIR-12
**Track:** Paired HLD + LLD
**HLD case study:** [CS-HLD-C05](../hld/classic/CS-HLD-C05-uber-ride-sharing.md)
**LLD case study:** [CS-LLD-O21](../lld/classic-ood/CS-LLD-O21-ride-sharing-uber.md)
**HLD question:** [Q05-uber-ride-sharing.md](../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q05-uber-ride-sharing.md)
**LLD question:** [Q21-ride-sharing-uber.md](../../System Design - Low Level Design/02-classic-ood/questions/Q21-ride-sharing-uber.md)
...
**MVP success criteria for Ride Sharing (Uber):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Ride Sharing (Uber)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Uber trip state machine and matching (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q21-ride-sharing-uber.md](../../System%20Design%20-%20Low%20Level%20Design/02-classic-ood/questions/Q21-ride-sharing-uber.md)
- **End-to-end pair:** [CS-PAIR-12-uber-ride-sharing.md](CS-PAIR-12-uber-ride-sharing.md)
...
- [Java implementation](../../System Design - Low Level Design/09-code-implementations/java/classic/ride-sharing-uber/Demo.java) (full)
