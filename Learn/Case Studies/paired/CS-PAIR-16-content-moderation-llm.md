# Content Moderation for LLM Apps — End-to-End Case Study

**Case Study ID:** CS-PAIR-16
**Track:** Paired HLD + LLD
**HLD case study:** [CS-HLD-G15](../hld/genai/CS-HLD-G15-content-moderation-llm.md)
**LLD case study:** [CS-LLD-A08](../lld/genai/CS-LLD-A08-guardrail-safety-chain.md)
**HLD question:** [Q15-content-moderation-llm.md](../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q15-content-moderation-llm.md)
**LLD question:** [Q08-guardrail-safety-chain.md](../../System Design - Low Level Design/05-genai-llm-lld/questions/Q08-guardrail-safety-chain.md)
...
**Industry analog:** Leading products in the Content Moderation for LLM Apps domain
...
**MVP success criteria for Guardrail / Safety Filter Chain:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Guardrail / Safety Filter Chain**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Anthropic Constitutional AI and OpenAI moderation (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q08-guardrail-safety-chain.md](../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q08-guardrail-safety-chain.md)
- **End-to-end pair:** [CS-PAIR-16-content-moderation-llm.md](CS-PAIR-16-content-moderation-llm.md)
...
- [Java implementation](../../System Design - Low Level Design/09-code-implementations/java/genai/guardrail-safety-chain/README.md) (full)
