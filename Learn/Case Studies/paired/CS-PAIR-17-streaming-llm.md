# Streaming LLM Responses — End-to-End Case Study

**Case Study ID:** CS-PAIR-17
**Track:** Paired HLD + LLD
**HLD case study:** [CS-HLD-G02](../hld/genai/CS-HLD-G02-rag-document-qa.md)
**LLD case study:** [CS-LLD-A09](../lld/genai/CS-LLD-A09-streaming-response-aggregator.md)
...
**LLD question:** [Q09-streaming-response-aggregator.md](../../System Design - Low Level Design/05-genai-llm-lld/questions/Q09-streaming-response-aggregator.md)
...
- **End-to-end pair:** [CS-PAIR-17-streaming-llm.md](CS-PAIR-17-streaming-llm.md)
...
- [Java implementation](../../System Design - Low Level Design/09-code-implementations/java/genai/streaming-response-aggregator/README.md) (skeleton)
