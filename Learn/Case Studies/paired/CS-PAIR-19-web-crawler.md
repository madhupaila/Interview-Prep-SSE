# Web Crawler at Scale — End-to-End Case Study

**Case Study ID:** CS-PAIR-19
**Track:** Paired HLD + LLD
**HLD case study:** [CS-HLD-C09](../hld/classic/CS-HLD-C09-web-crawler.md)
**LLD case study:** [CS-LLD-X11](../lld/concurrency/CS-LLD-X11-web-crawler-multithreaded.md)
**HLD question:** [Q09-web-crawler.md](../../System%20Design%20-%20High%20Level%20Design/03-classic-hld/questions/Q09-web-crawler.md)
**LLD question:** [Q11-web-crawler-multithreaded.md](../../System Design - Low Level Design/04-concurrency-lld/questions/Q11-web-crawler-multithreaded.md)
...
**Industry analog:** Googlebot crawl frontier and politeness

This case study examines **Design Web Crawler** — a system type commonly built at Google and similar organizations. Design a scalable system for: **Web Crawler**.
...
|----------|-------------|---------------------|
| Must | Core features for web crawler | Verified in integration tests |
| Must | User authentication and authorization | Verified in integration tests |
| Must | bloom filter politeness | Verified in integration tests |
...
|---|----------|-----------------|
| 1 | Scale (DAU, QPS)? | 1B pages |
| 2 | Read vs write ratio? | BFS frontier |
...
| 7 | MVP scope? | Core bloom filter politeness |
...
**Status:** Accepted  
**Context:** Need to balance delivery speed, operability, and scale for Design Web Crawler.  
...
```
Scheduler → Frontier Queue → Crawler Workers → Parser → Content DB
...
**MVP success criteria for Web Crawler (Multithreaded):** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Web Crawler (Multithreaded)**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | Googlebot — parallel fetch with URL frontier (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q11-web-crawler-multithreaded.md](../../System%20Design%20-%20Low%20Level%20Design/04-concurrency-lld/questions/Q11-web-crawler-multithreaded.md)
- **End-to-end pair:** [CS-PAIR-19-web-crawler.md](CS-PAIR-19-web-crawler.md)
...
- [Java implementation](../../System Design - Low Level Design/09-code-implementations/java/concurrency/web-crawler-multithreaded/README.md) (full)
