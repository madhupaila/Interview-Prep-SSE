# Token Budget & Cost Control — End-to-End Case Study

**Case Study ID:** CS-PAIR-20
**Track:** Paired HLD + LLD
**HLD case study:** [CS-HLD-G34](../hld/genai/CS-HLD-G34-cost-optimized-llm-routing.md)
**LLD case study:** [CS-LLD-A05](../lld/genai/CS-LLD-A05-token-budget-manager.md)
**HLD question:** [Q34-cost-optimized-llm-routing.md](../../System%20Design%20-%20High%20Level%20Design/02-genai-llm-hld/questions/Q34-cost-optimized-llm-routing.md)
**LLD question:** [Q05-token-budget-manager.md](../../System Design - Low Level Design/05-genai-llm-lld/questions/Q05-token-budget-manager.md)
...
**MVP success criteria for Token Budget Manager:** Core flows demo-ready; p99 within 2× target; on-call runbook draft.
...
> This is a 30-minute senior loop for **Token Budget Manager**. Spend 5 minutes on context, 10 on HLD, 10 on LLD/boundaries, 5 on ops.
...
| Capability | OpenAI token counting and context window limits (reference) | This design (MVP) | Scale phase |
|------------|----------------------|-------------------|-------------|
...
- **Question file:** [Q05-token-budget-manager.md](../../System%20Design%20-%20Low%20Level%20Design/05-genai-llm-lld/questions/Q05-token-budget-manager.md)
- **End-to-end pair:** [CS-PAIR-20-token-budget-cost.md](CS-PAIR-20-token-budget-cost.md)
...
- [Java implementation](../../System Design - Low Level Design/09-code-implementations/java/genai/token-budget-manager/README.md) (skeleton)
