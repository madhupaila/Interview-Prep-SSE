...
> **Full case study:** [CS-HLD-G09-ai-customer-support-bot.md](../../../Case Studies/hld/genai/CS-HLD-G09-ai-customer-support-bot.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Leading products in the Design AI Customer Support Bot domain. Read the full case study for requirements, constraints, ADRs, and ops.
