# Design Multi-Modal Q&A (Image+Text)
...
> **Full case study:** [CS-HLD-G16-multimodal-qa.md](../../../Case Studies/hld/genai/CS-HLD-G16-multimodal-qa.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Leading products in the Design Multi-Modal Q&A (Image+Text) domain. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core user-facing capability for multi-modal q&a (image+text)
