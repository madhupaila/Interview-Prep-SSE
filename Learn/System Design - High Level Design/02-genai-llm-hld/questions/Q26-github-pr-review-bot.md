...
> **Full case study:** [CS-HLD-G26-github-pr-review-bot.md](../../../Case Studies/hld/genai/CS-HLD-G26-github-pr-review-bot.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Leading products in the Design GitHub PR Review Bot domain. Read the full case study for requirements, constraints, ADRs, and ops.
