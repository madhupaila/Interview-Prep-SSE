...
> **Full case study:** [CS-HLD-G29-email-smart-compose.md](../../../Case Studies/hld/genai/CS-HLD-G29-email-smart-compose.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Leading products in the Design Email Smart Compose domain. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core user-facing capability for email smart compose
