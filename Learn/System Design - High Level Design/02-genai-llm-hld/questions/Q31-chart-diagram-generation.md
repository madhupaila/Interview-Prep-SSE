# Design Chart/Diagram Generation from Text
...
> **Full case study:** [CS-HLD-G31-chart-diagram-generation.md](../../../Case Studies/hld/genai/CS-HLD-G31-chart-diagram-generation.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Leading products in the Design Chart/Diagram Generation from Text domain. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core user-facing capability for chart/diagram generation from text
- Session/history management where applicable
- Admin: model version, prompt version, usage dashboards
- Mermaid/JSON schema validation
