# Design Function-Calling Tool Platform
...
> **Full case study:** [CS-HLD-G32-function-calling-platform.md](../../../Case Studies/hld/genai/CS-HLD-G32-function-calling-platform.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Leading products in the Design Function-Calling Tool Platform domain. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core user-facing capability for function-calling tool platform
