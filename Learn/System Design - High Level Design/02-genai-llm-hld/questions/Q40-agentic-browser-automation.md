# Design Agentic Browser Automation
...
> **Full case study:** [CS-HLD-G40-agentic-browser-automation.md](../../../Case Studies/hld/genai/CS-HLD-G40-agentic-browser-automation.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Leading products in the Design Agentic Browser Automation domain. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core user-facing capability for agentic browser automation
