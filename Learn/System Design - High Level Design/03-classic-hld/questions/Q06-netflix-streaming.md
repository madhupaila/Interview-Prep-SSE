...
> **Full case study:** [CS-HLD-C06-netflix-streaming.md](../../../Case Studies/hld/classic/CS-HLD-C06-netflix-streaming.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Leading products in the Design Netflix Video Streaming domain. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for netflix video streaming
