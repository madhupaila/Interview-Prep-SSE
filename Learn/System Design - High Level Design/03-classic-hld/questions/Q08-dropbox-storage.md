...
> **Full case study:** [CS-HLD-C08-dropbox-storage.md](../../../Case Studies/hld/classic/CS-HLD-C08-dropbox-storage.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Leading products in the Design Dropbox / File Storage domain. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for dropbox / file storage
