...
> **Full case study:** [CS-HLD-C10-typeahead-autocomplete.md](../../../Case Studies/hld/classic/CS-HLD-C10-typeahead-autocomplete.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Google search suggest and Trie prefix index. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for typeahead / autocomplete
