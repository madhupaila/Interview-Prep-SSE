...
> **Full case study:** [CS-HLD-C13-key-value-store.md](../../../Case Studies/hld/classic/CS-HLD-C13-key-value-store.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Leading products in the Design Key-Value Store domain. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for key-value store
