...
> **Full case study:** [CS-HLD-C15-news-aggregator.md](../../../Case Studies/hld/classic/CS-HLD-C15-news-aggregator.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Google News and Apple News ranking. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for news aggregator
