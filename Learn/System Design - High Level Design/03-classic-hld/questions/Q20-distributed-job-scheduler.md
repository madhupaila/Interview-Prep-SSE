...
> **Full case study:** [CS-HLD-C20-distributed-job-scheduler.md](../../../Case Studies/hld/classic/CS-HLD-C20-distributed-job-scheduler.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Airflow and Quartz distributed scheduling. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for distributed job scheduler
