...
> **Full case study:** [CS-HLD-C22-logging-system.md](../../../Case Studies/hld/classic/CS-HLD-C22-logging-system.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Splunk and ELK stack ingestion. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for logging system
