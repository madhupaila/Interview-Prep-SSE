...
> **Full case study:** [CS-HLD-C24-api-gateway.md](../../../Case Studies/hld/classic/CS-HLD-C24-api-gateway.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Kong and AWS API Gateway. Read the full case study for requirements, constraints, ADRs, and ops.
