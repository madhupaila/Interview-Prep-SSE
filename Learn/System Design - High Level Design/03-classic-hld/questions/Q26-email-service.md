...
> **Full case study:** [CS-HLD-C26-email-service.md](../../../Case Studies/hld/classic/CS-HLD-C26-email-service.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Gmail SMTP ingestion and storage. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for email service
