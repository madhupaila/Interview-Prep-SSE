...
> **Full case study:** [CS-HLD-C32-food-delivery-doordash.md](../../../Case Studies/hld/classic/CS-HLD-C32-food-delivery-doordash.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after DoorDash dispatch and ETA prediction. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for food delivery (doordash)
