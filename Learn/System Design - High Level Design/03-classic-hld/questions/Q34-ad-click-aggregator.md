...
> **Full case study:** [CS-HLD-C34-ad-click-aggregator.md](../../../Case Studies/hld/classic/CS-HLD-C34-ad-click-aggregator.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Google Ads real-time click aggregation. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for ad click aggregator
