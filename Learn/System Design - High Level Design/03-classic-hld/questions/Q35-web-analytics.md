# Design Web Analytics (Google Analytics)
...
> **Full case study:** [CS-HLD-C35-web-analytics.md](../../../Case Studies/hld/classic/CS-HLD-C35-web-analytics.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Google Analytics event pipeline. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for web analytics (google analytics)
