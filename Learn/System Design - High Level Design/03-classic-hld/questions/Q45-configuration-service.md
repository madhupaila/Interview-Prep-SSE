...
> **Full case study:** [CS-HLD-C45-configuration-service.md](../../../Case Studies/hld/classic/CS-HLD-C45-configuration-service.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Netflix Archaius and Spring Cloud Config. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for configuration service
