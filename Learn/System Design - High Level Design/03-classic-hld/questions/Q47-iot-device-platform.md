...
> **Full case study:** [CS-HLD-C47-iot-device-platform.md](../../../Case Studies/hld/classic/CS-HLD-C47-iot-device-platform.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after AWS IoT Core device shadow. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for iot device platform
