...
> **Full case study:** [CS-HLD-C48-weather-service.md](../../../Case Studies/hld/classic/CS-HLD-C48-weather-service.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Leading products in the Design Weather Service domain. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for weather service
- User authentication and authorization
- aggregation from stations
