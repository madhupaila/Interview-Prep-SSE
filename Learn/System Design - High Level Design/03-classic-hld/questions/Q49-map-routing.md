# Design Map / Routing (Google Maps)
...
> **Full case study:** [CS-HLD-C49-map-routing.md](../../../Case Studies/hld/classic/CS-HLD-C49-map-routing.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Google Maps routing and traffic-aware ETA. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for map / routing (google maps)
