...
> **Full case study:** [CS-HLD-C50-bloom-filter-service.md](../../../Case Studies/hld/classic/CS-HLD-C50-bloom-filter-service.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Chrome Safe Browsing and Cassandra BF. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for bloom filter service
