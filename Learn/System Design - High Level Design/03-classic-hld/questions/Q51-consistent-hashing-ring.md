# Design Consistent Hashing Ring
...
> **Full case study:** [CS-HLD-C51-consistent-hashing-ring.md](../../../Case Studies/hld/classic/CS-HLD-C51-consistent-hashing-ring.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Dynamo and Cassandra token ring. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for consistent hashing ring
