...
> **Full case study:** [CS-HLD-C55-data-pipeline-etl.md](../../../Case Studies/hld/classic/CS-HLD-C55-data-pipeline-etl.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Airflow and dbt batch pipelines. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for data pipeline / etl
