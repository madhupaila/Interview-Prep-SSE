# Design Chatbot (Rule-Based, Pre-LLM)
...
> **Full case study:** [CS-HLD-C59-rule-based-chatbot.md](../../../Case Studies/hld/classic/CS-HLD-C59-rule-based-chatbot.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Dialogflow pre-LLM intent matching. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for chatbot (rule-based, pre-llm)
