...
> **Full case study:** [CS-HLD-C60-identity-sso.md](../../../Case Studies/hld/classic/CS-HLD-C60-identity-sso.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Okta and Auth0 OIDC/SAML. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for identity / sso system
