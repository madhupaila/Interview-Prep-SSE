...
> **Full case study:** [CS-HLD-C61-backup-disaster-recovery.md](../../../Case Studies/hld/classic/CS-HLD-C61-backup-disaster-recovery.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after AWS Backup cross-region RPO/RTO. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for backup and disaster recovery
