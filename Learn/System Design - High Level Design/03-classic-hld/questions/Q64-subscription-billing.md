...
> **Full case study:** [CS-HLD-C64-subscription-billing.md](../../../Case Studies/hld/classic/CS-HLD-C64-subscription-billing.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Stripe Billing and dunning. Read the full case study for requirements, constraints, ADRs, and ops.
