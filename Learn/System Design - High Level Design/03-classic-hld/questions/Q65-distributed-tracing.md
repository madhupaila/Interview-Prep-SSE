...
> **Full case study:** [CS-HLD-C65-distributed-tracing.md](../../../Case Studies/hld/classic/CS-HLD-C65-distributed-tracing.md)
> **Read order:** Case Study → this question (timed mock)

**Business context:** Real-world context modeled after Jaeger and Datadog APM. Read the full case study for requirements, constraints, ADRs, and ops.
...
- Core features for distributed tracing system
